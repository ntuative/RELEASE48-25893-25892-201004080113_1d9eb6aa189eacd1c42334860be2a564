package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_105:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_183:PurchaseConfirmationDialog;
      
      private var var_451:IHabboSoundManager;
      
      private var var_290:CatalogViewer;
      
      private var var_1674:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_376:ICatalogNavigator;
      
      private var var_573:IAvatarRenderManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_79:RecyclerLogic;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_1675:GiftWrappingConfiguration;
      ...
      private var var_964:ClubGiftController;
      ...
      {
         return var_342.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_144.credits = _loc3_.balance;
         updatePurse();
         if(!var_1676 && var_451 != null)
         {
            var_451.playSound(HabboSoundTypesEnum.const_911);
         }
         var_1676 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_342.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_81)
         {
            _loc3_ = var_342.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_79 == null)
         {
            return;
         }
         var_79.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_183.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_94:
               var_1140 = param1.session.isPrivateRoom;
               if(var_79 != null)
               {
                  var_79.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_100:
               ...
               if(var_79 != null)
               {
                  var_79.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_79.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_147.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_147.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1675 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_79 != null && getCurrentLayoutCode() == "recycler")
            {
               var_79.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_208,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_964.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_376 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_79 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_144.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_144.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_964 == null)
         {
            var_964 = new ClubGiftController(this);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_105.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_183 == null)
            {
               var_183 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_183.showOffer(this,param1,param2,param3,_loc7_);
      ...
      private function createMarketPlace() : void
      {
         if(var_105 == null)
         {
            var_105 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_376.buildCatalogIndex(_loc2_);
         if(var_965 != "")
         {
            var_376.openPage(var_965);
            var_965 = "";
         }
         else
         {
            var_376.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_178)
         {
            _loc3_ = var_147.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_290 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_290.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_79.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_144.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_144.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_144.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_144.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_290.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_144.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1674 && var_451 != null)
         {
            var_451.playSound(HabboSoundTypesEnum.const_833);
         }
         var_1674 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_290.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_290.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_290 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_290.habboCatalog = this;
      }
