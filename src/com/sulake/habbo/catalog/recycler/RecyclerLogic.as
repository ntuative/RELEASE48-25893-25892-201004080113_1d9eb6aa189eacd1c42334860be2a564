package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_745:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1413)
         {
            case RecyclerStatusMessageEvent.const_1226:
               ...
               break;
            case RecyclerStatusMessageEvent.const_801:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1178:
               if(_view == null)
               {
                  return;
               }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_94.length)
         {
            _loc3_ = var_94[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      {
         return var_1413 != RecyclerStatusMessageEvent.const_801;
      }
      
      private function get statusActive() : Boolean
      {
         return var_251 != const_746;
      }
      ...
      {
         return active && var_251 == const_339;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            oldObjectData = var_94[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_161)
            {
               oldObjectData = var_94[newSlotId];
         ...
         var_94[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         updateRecyclerSlots();
         updateRecyclerButton();
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_888:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1382:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!_catalog.returnInventoryFurniFromRecycler(var_94[param1].id))
         {
            return;
         }
         var_94[param1] = null;
