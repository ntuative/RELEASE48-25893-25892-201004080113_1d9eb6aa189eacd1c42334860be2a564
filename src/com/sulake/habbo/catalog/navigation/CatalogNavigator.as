package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2349:String = "magic.pixels";
      
      private var var_2348:String = "catalog.page.club";
      
      private var var_2378:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_276 = [];
         var_49 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_30,onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_30,onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_30,onNavigatorEvent);
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_274,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.WINDOW_EVENT_DISABLE,deActivateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_227,deActivateScrollbar);
         }
      }
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2348,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_276.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_276)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_276.indexOf(_loc6_);
            var_276.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_49);
            }
         }
      }
