package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1126:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1578:XML;
      
      private static var var_1576:XML;
      ...
      private var var_1577:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1577 == 4294967295)
            {
               var_1577 = _loc1_.color;
            }
            _loc1_.color = const_1126;
         }
      }
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_34,onIconImageReady);
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1356;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1578) as IWindowContainer;
         }
         else
         {
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(var_49);
            }
         }
         if(var_49 != null)
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1576) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1289;
            }
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(var_49);
            }
         }
         if(var_49 != null)
         {
