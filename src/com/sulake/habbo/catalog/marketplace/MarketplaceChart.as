package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_987 + var_987 / -var_2342 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_822 - var_822 / var_389 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_389).toString().length - 1);
         var_389 = Math.ceil(var_389 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_389.toString();
         _loc3_.draw(_loc6_);
         var_987 = param1 - _loc6_.textWidth - 2;
         var_822 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_822);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_822 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_987 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_987,(param2 - var_822) / 2));
         return _loc3_;
      }
