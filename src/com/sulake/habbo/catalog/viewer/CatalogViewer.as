package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1466:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_564 != null)
         {
            if(var_564.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_564.window);
            var_564.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1466);
         var_564 = _loc5_;
      ...
      {
         return var_564.dispatchWidgetEvent(param1);
      }
