package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1399:String = "ctlg_";
      ...
      private var var_915:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1399 + param1;
         ...
         var_1388 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1388) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_893);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1377) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1150) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1305;
            _loc2_.init();
         }
         var_1305.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1305.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_893);
      }
