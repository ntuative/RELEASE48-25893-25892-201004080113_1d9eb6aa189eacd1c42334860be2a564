package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_783:MarketPlaceOfferData;
      
      private const const_1407:int = 1;
      
      private const const_1622:int = 40;
      
      private var var_454:IWindowContainer;
      
      private const const_1408:int = 2;
      ...
      private const const_1623:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_454)
         {
            ...
            var_454 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_454)
         {
            return;
         ...
         updateStatusDisplay(const_1408,_loc2_.length);
         if(!var_381)
         {
            var_381 = new Timer(25);
            var_381.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_784 = 0;
         populateList();
         var_381.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_454 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_454.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1407);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_382.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_381)
         {
            var_381.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_381 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_784 >= var_548.length)
            {
               return true;
            }
            addListItem(var_548.getWithIndex(var_784));
            ++var_784;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_783.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_143)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_382));
            _loc7_.selection = 0;
         }
      }
