package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1065 != null)
         {
            var_1065.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1066 != null)
         {
            var_1066.removeEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1065 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1065 != null)
         {
            var_1065.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1066 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1066 != null)
         {
            var_1066.addEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
