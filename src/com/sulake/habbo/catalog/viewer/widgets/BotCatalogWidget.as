package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_941:IItemGridWindow;
      
      protected var var_1341:XML;
      
      private var var_1436:Map;
      
      private var var_808:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_941 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1341) as IWindowContainer;
         var_941.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1436.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_96);
         var _loc5_:IBitmapWrapperWindow = _loc2_.findChildByName("image") as IBitmapWrapperWindow;
         _loc5_.bitmap = new BitmapData(_loc5_.width,_loc5_.height,true,16777215);
         _loc4_.setDirection(AvatarSetType.const_38,4);
         var _loc6_:BitmapData = _loc4_.getImage(AvatarSetType.const_38);
         _loc5_.bitmap.copyPixels(_loc6_,_loc6_.rect,new Point((_loc5_.width - _loc6_.width) / 2,_loc5_.height - _loc6_.height));
         _loc5_.invalidate();
      }
      ...
      {
         var _loc1_:String = var_1436.getValue(var_808.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc2_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc1_,AvatarScaleType.const_51);
         _loc2_.setDirection(AvatarSetType.const_38,4);
         setPreviewImage(_loc2_.getImage(AvatarSetType.const_38));
         _loc2_.dispose();
      }
      
      private function onBuyButtonEvent(param1:WindowEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_808,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_808.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_808.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_808.localizationId);
