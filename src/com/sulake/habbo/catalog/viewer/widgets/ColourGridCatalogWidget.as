package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1272 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_304 = null;
         for each(_loc1_ in var_1273)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1272) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_678.width,var_678.height,true,0);
               _loc3_.bitmap.copyPixels(var_678,var_678.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_836.width,var_836.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_680.width,var_680.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_680,var_680.rect,new Point(0,0),null,null,true);
