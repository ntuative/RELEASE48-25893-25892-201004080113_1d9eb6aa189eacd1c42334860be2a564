package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1275:String = "Memory";
      ...
      private var var_1277:String = "1.1";
      ...
      private var _floorType:String = "Memory";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_283 != null && var_285 != null)
         {
            setRoomImage(var_283,var_285);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_147.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_241 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_241];
                  if(_loc9_ != null)
                  {
                     var_1275 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_147.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_282];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_147.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_284];
               if(_loc13_ != null)
               {
                  var_1277 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_187:
               ...
               for each(_loc8_ in var_147.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_753 = _loc8_.children().length();
                  }
               }
            ...
            case const_188:
               ...
               if(var_317 >= _activeFloorPatterns.length)
               {
                  var_317 = 0;
               }
               var_282 = 0;
               ...
               for each(_loc9_ in var_147.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_754 = _loc9_.children().length();
                  }
               }
            ...
            case const_189:
               ...
               for each(_loc10_ in var_147.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_755 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1275);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1275,var_1277,64,this,"window_romantic_wide");
