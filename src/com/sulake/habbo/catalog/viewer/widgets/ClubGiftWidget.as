package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_47:ClubGiftController;
      ...
      private function updateList() : void
      {
         ...
         var_548.reset();
         _loc2_ = var_47.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = var_47.getGiftData();
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         return var_47.windowManager.buildFromXML(_loc3_);
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(false)
         {
            ...
            var_47.localization.registerParameter(_loc2_,"amount",var_47.giftsAvailable.toString());
         }
         else if(false)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            var_47.localization.registerParameter(_loc2_,"days",var_47.daysUntilNextGift.toString());
         }
         else if(false)
         {
         ...
         _loc1_.text = var_47.localization.getKey(_loc2_);
      }
      ...
      {
         if(!param1 || !param2 || !var_548 || !var_47)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         var _loc6_:String = var_47.localization.getKey("catalog.club_gift.months_required");
      ...
      private function setImage(param1:IWindow, param2:String, param3:Boolean) : void
      {
         ...
         var _loc5_:BitmapDataAsset = var_47.assets.getAssetByName(param2) as BitmapDataAsset;
         if(!_loc5_)
         {
            return;
         }
      ...
      private function mouseOverHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_30)
         {
            hidePreview();
         }
      }
