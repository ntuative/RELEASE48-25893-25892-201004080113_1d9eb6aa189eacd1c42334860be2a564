package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1486:Point;
      
      private var var_1966:Array;
      
      private var var_576:IItemGridWindow;
      
      private var var_82:IBitmapWrapperWindow;
      
      private var var_1186:ITextWindow;
      
      private var var_1237:IScrollbarWindow;
      
      protected var var_1341:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_576 != null)
         {
            var_576.visible = false;
            var_576.destroyGridItems();
         }
         if(var_1237 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1186.text = "${" + _loc3_.name + "}";
            var_1185.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1186.text = "${" + _loc2_.localizationId + "}";
            var_1185.text = "${" + _loc2_.localizationId + "}";
         }
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            setPreviewFromAsset(ProductImageConfiguration.const_35[_loc2_.localizationId]);
         }
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_375:
                  _loc4_ = var_1238.clone();
                  if(var_576 != null)
                  {
                     var_576.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_576,var_1237,var_1341);
                  }
                  break;
               ...
               case Offer.const_409:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_202:
                        ...
                        _loc4_ = new BitmapData(var_82.width,var_82.height,false,_loc10_);
                        _loc11_ = null;
                        _loc12_ = page.viewer.catalog as HabboCatalog;
                        if(_loc12_.avatarRenderManager != null)
                        {
                           _loc14_ = _loc12_.sessionDataManager.figure;
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_51);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_46,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_297,AvatarAction.const_501);
                              _loc13_.appendAction(AvatarAction.const_671,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_38);
      ...
      {
         var_1186 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1185 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1486 = new Point(var_82.x,var_82.y);
         var_576 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1237 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_576 == null)
         {
         ...
         var_1238 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_82);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_34,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_82 != null && true)
         {
            ...
            if(true)
            {
               var_82.bitmap = new BitmapData(var_82.width,var_82.height,true,16777215);
            }
            var_82.bitmap.fillRect(var_82.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_82.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_82.invalidate();
            var_82.x = var_1486.x;
            var_82.y = var_1486.y;
            if(param3 != null)
