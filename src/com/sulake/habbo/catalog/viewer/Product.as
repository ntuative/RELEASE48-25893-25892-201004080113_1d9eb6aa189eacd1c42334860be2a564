package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1357:IProductData;
      ...
      {
         super();
         var_1355 = param1.productType;
         var_1354 = param1.furniClassId;
         var_1090 = param1.extraParam;
         var_1091 = param1.productCount;
         var_1356 = param1.expiration;
         var_1357 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_81:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1090);
               break;
