package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1425:uint = 4.293848814E9;
      
      private var var_842:int;
      
      private const const_1633:uint = 4.291613146E9;
      ...
      private const const_1632:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_225.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_841;
               }
            }
            _loc4_++;
         }
      ...
      {
         if(this.var_76 == null || this.var_76.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = _catalog.getProductData(var_76.localizationId);
         ...
         switch(var_76.priceType)
         {
            ...
            case Offer.const_456:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_76.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_76.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_76.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_841,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1425) : uint(const_1426);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1429;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_79);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_564,var_76,var_1022);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_225.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_841);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_569[var_192]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_570[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_564,var_76,var_1022,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_143:
               ...
               if(var_1917 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_233)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1632)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1917 = _loc3_.text;
               break;
            case WindowMouseEvent.const_50:
               showSuggestions(false);
               if(var_1212)
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = _catalog.getProductData(var_76.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = var_76.page.viewer.roomEngine;
            _loc6_ = var_76.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_81:
                  ...
                  break;
               case ProductTypeEnum.const_202:
                  _loc7_ = _catalog.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_471:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1429 = _loc1_.stuffTypes;
            var_569 = _loc1_.boxTypes;
            var_570 = _loc1_.ribbonTypes;
            var_841 = var_1429[0];
            var_192 = var_569[0];
            _ribbonIndex = var_570[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_225.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_225 == null)
         {
            var_225 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_485 == null)
         {
            var_485 = createWindow("suggestion_list_item") as IWindowContainer;
            var_485.procedure = suggestionsEventHandler;
         }
         if(var_225 == null || var_485 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_225.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_485.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
