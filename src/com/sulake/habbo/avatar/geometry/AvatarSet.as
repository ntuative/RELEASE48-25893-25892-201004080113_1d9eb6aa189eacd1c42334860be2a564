package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      private var var_1034:Dictionary;
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1978 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_1034 = new Dictionary();
         var_1489 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_1034[String(_loc3_.@id)] = _loc5_;
         }
         for each(_loc4_ in param1.bodypart)
         {
            var_1489.push(String(_loc4_.@id));
         }
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1489.concat();
