package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_711:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1049:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_711 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1049 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_711)
         {
            var_711.removeListItems();
         }
         if(var_1049)
         {
            var_1049.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_711)
               {
                  var_711.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1049)
            {
               var_1049.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
