package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1640:uint;
      
      private var _rgb:uint;
      
      private var var_958:Map;
      
      private var var_1542:Number = 1;
      
      private var _b:uint;
      
      private var var_1539:Number = 1;
      ...
      {
         super();
         var_1404 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1640 = parseInt(_loc2_,16);
         var_1641 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1540 = _rgb >> 16 & 255;
         var_1541 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1538 = var_1540 / 255 * 1;
         ...
         _colorTransform = new ColorTransform(var_1538,var_1539,var_1542,_alphaMultiplier);
         var_958 = generatePaletteMapForGrayscale(var_1641,var_1640);
      }
      
      public function get reds() : Array
      {
         return var_958.getValue("reds") as Array;
      }
      ...
      {
         return var_958.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_958.getValue("greens") as Array;
      }
      ...
      {
         return var_958.getValue("alphas") as Array;
      }
