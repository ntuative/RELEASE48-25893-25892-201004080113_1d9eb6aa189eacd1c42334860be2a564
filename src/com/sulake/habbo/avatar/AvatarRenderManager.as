package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1123:AssetAliasCollection;
      
      private var var_956:PaletteManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_80:
               _loc3_ = var_212.getValue(AvatarType.const_80) as AvatarStructure;
               break;
            case AvatarType.PET:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_212.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_1123 = new AssetAliasCollection(_loc1_,_loc3_);
         var_643 = new PetDataManager(_loc1_,_loc3_);
         var_956 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_212.add(AvatarType.const_80,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_212.add(AvatarType.PET,_loc5_);
      ...
      {
         var_742 = param1;
         if(var_742 == RenderMode.const_1228)
         {
            init();
         }
         if(var_742 == RenderMode.const_1177)
         {
            init();
      ...
      {
         return var_1123.getAssetByName(param1);
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_212.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc6_,var_1123,_loc5_,param4,AvatarType.PET);
      }
      ...
      {
         var _loc3_:AvatarStructure = var_212.getValue(AvatarType.const_80) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_1123,param1,param2,AvatarType.const_80);
      }
