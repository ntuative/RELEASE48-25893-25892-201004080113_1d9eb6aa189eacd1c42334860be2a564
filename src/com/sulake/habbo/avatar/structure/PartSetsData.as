package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      private var var_919:Dictionary;
      
      public function PartSetsData()
      {
         super();
         var_169 = new Dictionary();
         var_919 = new Dictionary();
      }
      ...
      {
         return var_169[param1] as PartDefinition;
      }
      
      public function getActiveParts(param1:IActionDefinition) : Array
      {
         var _loc2_:ActivePartSet = var_919[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function addPartDefinition(param1:XML) : PartDefinition
      {
         ...
         if(true)
         {
            var_169[_loc2_] = new PartDefinition(param1);
         }
         return var_169[_loc2_];
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_169[String(_loc2_["set-type"])] = new PartDefinition(_loc2_);
         }
         for each(_loc3_ in param1.activePartSet)
         {
            var_919[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_919[param1.activePartSet] as ActivePartSet;
      }
