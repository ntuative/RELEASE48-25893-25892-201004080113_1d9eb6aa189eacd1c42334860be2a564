package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private var var_695:int = -1;
      
      private var var_169:Array;
      
      private var var_199:Array;
      
      private const const_1652:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_695 >= 0 && var_169.length > var_695)
         {
            _loc2_ = var_169[var_695];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_169.length > param1)
         {
            _loc3_ = var_169[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_231[0] as Array;
         ...
         {
            _loc7_ = var_231[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_199[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_199[param2],param2);
         var_199[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_199[param1])
         {
            return null;
         }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_231.length <= param1)
         {
            return null;
         }
         return var_231[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_169[var_695] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_231)
         {
            for each(_loc2_ in var_231 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_199 = new Array(param1.length);
         var _loc3_:int = 0;
         while(_loc3_ < var_231.length)
         {
