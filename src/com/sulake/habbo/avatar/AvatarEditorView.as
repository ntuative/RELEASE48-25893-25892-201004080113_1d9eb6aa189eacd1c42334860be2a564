package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1599:IWindowContainer;
      
      public static var var_1372:IWindowContainer;
      
      public static var var_2257:int = 6710886;
      ...
      private var var_1451:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1372 == null)
         {
            ...
            var_1372 = var_47.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1599 == null)
         {
            _loc5_ = var_47.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1599 = var_47.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1451 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1449 == AvatarEditorSideCategory.WARDROBE || var_1805))
         {
            _loc4_ = "null";
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_472)
         {
            ...
            var_472 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_472.procedure = stripClubDialogEventProc;
            var_472.center();
         }
         else
         {
            var_472.visible = true;
            var_472.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_707:
               break;
            case AvatarEditorSideCategory.const_373:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_373);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_279 = param1;
         var_1451.setSelected(var_1451.getSelectableByName(param1));
         _window.invalidate();
      }
