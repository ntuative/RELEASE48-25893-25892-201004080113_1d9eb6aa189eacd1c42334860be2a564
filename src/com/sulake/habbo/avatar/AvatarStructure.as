package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_439:PartSetsData;
      
      private var var_2226:PartOffsetData;
      
      private var var_923:AvatarActionManager;
      
      private var var_177:IAssetLibrary;
      
      private var var_1089:IAssetLibrary;
      
      private var var_1375:Boolean = false;
      
      private var var_2225:AvatarRenderManager;
      
      private var var_440:FigureData;
      ...
      private var var_1588:AvatarStructureDownloadSet;
      
      private var var_748:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_177 = param2;
         var_1089 = param3;
         var_440 = new FigureData();
         var_439 = new PartSetsData();
         _animationData = new AnimationData();
         var_1588 = new AvatarStructureDownloadSet();
         var_748 = new AnimationManager();
         var_749 = param4;
         var_2226 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_923.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_749)
         {
            case AvatarType.const_80:
               _loc1_ = var_177.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_439.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_177.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_177.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_440.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_177.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_439.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_177.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_177.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_440.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_923.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_440.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_923.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_748.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_439.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_439.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1336[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_923.getDefaultActionType();
         var _loc9_:Array = var_439.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_748.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_440.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_440.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = _animationData.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_439.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_439.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_177.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_177.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_177.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_177.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_749 + " ready to go!");
         if(var_749 == AvatarType.const_80)
         {
            var_439.getPartDefinition("ri").appendToFigure = true;
            var_439.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_177.hasAsset(_loc5_))
               {
                  var_177.removeAsset(var_177.getAssetByName(_loc5_));
               }
               var_1588.add(new AvatarStructureDownload(var_177,_loc5_,var_440));
               break;
            case AvatarType.PET:
         }
         var_1588.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_748.getAnimation(param1);
      }
      ...
      {
         var_923 = new AvatarActionManager(var_177,var_749);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1089.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1089.getAssetByName("dance" + _loc1_).content as XML;
            var_748.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1089.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1089.getAssetByName("fx" + _loc1_).content as XML;
            var_748.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_440.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_440.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_923.sortActions(param1);
      }
   }
}
