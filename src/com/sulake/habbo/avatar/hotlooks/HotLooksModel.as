package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1541:String = "hot_looks";
      
      public static const const_1574:String = "my_looks";
       
      
      private var var_377:Dictionary;
      
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         super(param1);
         var_377 = new Dictionary();
         var_377["null"] = new Array();
         var_377["null"] = new Array();
         var_377["undefined.index"] = 0;
         var_377["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      private function requestHotLooks() : void
      {
         ...
         _loc3_.addEventListener(AssetLoaderEvent.const_34,onHotLooksConfiguration);
      }
      
      public function selectHotLook(param1:int) : void
      {
         var _loc2_:Array = var_377["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_377[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
