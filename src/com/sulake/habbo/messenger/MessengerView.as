package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1188:ConversationView;
      ...
      private function sendMsg() : void
      {
         ...
         var_665.text = "";
         var_131.conversations.addMessageAndUpdateView(new Message(Message.const_570,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_13 == null)
         {
            prepareContent();
            refresh(true);
            var_131.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MESSENGER,var_13));
         }
         else
         {
            refresh(true);
      ...
      {
         var_13 = IFrameWindow(var_131.getXmlWindow("main_window"));
         ...
         var_831 = new ConversationsTabView(var_131,var_13);
         var_831.refresh();
         var_665 = ITextFieldWindow(var_13.findChildByName("message_input"));
         var_665.addEventListener(WindowKeyboardEvent.const_148,onMessageInput);
         var_1188 = new ConversationView(var_131,var_13);
         var_13.scaler.setParamFlag(HabboWindowParam.const_629,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_910,true);
      }
   }
}
