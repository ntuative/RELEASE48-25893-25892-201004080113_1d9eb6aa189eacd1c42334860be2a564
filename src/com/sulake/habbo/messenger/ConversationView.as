package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1042:int = 20;
      
      private static const const_749:int = 100;
       
      
      private var var_1694:IScrollbarWindow;
      
      private var var_131:HabboMessenger;
      
      private var var_1418:IContainerButtonWindow;
      
      private var var_457:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_131 = param1;
         var_1418 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1694 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_570 || param3.type == Message.const_605 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_457.messages.length - const_749);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_457.messages.length)
         {
            refreshEntry(true,_loc1_,var_457.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_457 == null || _loc1_.id != var_457.id)
         {
            var_457 = _loc1_;
            refreshList();
            method_4();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_749 + const_1042)
         {
            refreshList();
            method_4();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_131.send(new FollowFriendMessageComposer(var_457.id));
      }
      ...
      {
         if(param1 == Message.const_570)
         {
            return 4294967295;
         }
         if(param1 == Message.const_605)
         {
            return 4292801535;
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1043;
         param1.invalidate();
      }
   }
}
