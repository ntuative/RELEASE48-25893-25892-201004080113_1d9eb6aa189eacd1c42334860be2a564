package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_298.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_31)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_124,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_837,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_157,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_162,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_47,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_382,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_678,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_795,onHideWindowEvent);
         var_31 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_82));
      }
