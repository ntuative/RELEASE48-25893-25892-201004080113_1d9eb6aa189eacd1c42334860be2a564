package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_497:Point = null;
      
      private var var_710:Map = null;
      ...
      {
         return [RoomSessionChatEvent.const_134];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_498 != null)
         {
            ...
            {
               _loc2_ = var_498.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_134:
               _loc3_ = param1 as RoomSessionChatEvent;
               if(_loc3_ != null)
               {
                  _loc4_ = _container.roomEngine.getRoomObject(_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.userId,RoomObjectCategoryEnum.const_36);
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_498.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_710.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_322:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_96);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_96);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_498.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_710.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
                        ...
                        _loc14_ = "null";
                        _loc2_ = new RoomWidgetChatUpdateEvent(_loc14_,_loc3_.userId,_loc3_.text,_loc11_,RoomObjectCategoryEnum.const_36,_loc6_,_loc7_,_loc13_,_loc12_,_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.chatType);
                     }
                  }
               }
         }
      ...
      {
         return [RoomWidgetChatMessage.const_615,RoomWidgetChatSelectAvatarMessage.const_634];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_615:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_134,_container.roomSession,0,"Version 25893-25892-201004080040");
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_101:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_117:
                           _container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_634:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_873 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_873);
            }
            if(var_497 == null)
            {
               var_499.x = 0;
               var_499.y = 0;
               var_499.z = 0;
               var_497 = _loc4_.getScreenPoint(var_499);
               var_873 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_499.x = 0;
            var_499.y = 0;
            var_499.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_499);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_497.x || _loc8_.y != var_497.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_497,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_303;
      }
