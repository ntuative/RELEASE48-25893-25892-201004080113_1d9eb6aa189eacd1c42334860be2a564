package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1634:String = "room_widget";
      
      private const const_1101:String = "room_view";
      
      private var var_53:IWindowContainer;
      
      private var var_692:int = 50;
      
      private var var_2312:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_53.getChildByTag(const_1101) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_53.findChildByTag(const_1101) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_692;
               _loc2_.width = var_53.desktop.width - var_692;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_692;
               _loc2_.height = var_53.desktop.height - var_692;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_53.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_53.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_269,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1634) == 0)
            {
