package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_561);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_597);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_723);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_122:
               ...
               break;
            case FriendRequestEvent.const_52:
            case FriendRequestEvent.const_235:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_561:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_36,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_597:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_723:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_52);
         _loc1_.push(FriendRequestEvent.const_235);
         return _loc1_;
      }
