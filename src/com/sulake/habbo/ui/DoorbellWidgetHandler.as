package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_102:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_676,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_119:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_119,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_628];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_628:
      ...
      {
         return [RoomSessionDoorbellEvent.const_102,RoomSessionDoorbellEvent.const_119,RoomSessionDoorbellEvent.const_52];
      }
