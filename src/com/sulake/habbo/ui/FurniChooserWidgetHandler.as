package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = _container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_31);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = _container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.const_31);
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_309);
               ...
               _loc3_.push(new ChooserItem(_loc8_.getId(),RoomObjectCategoryEnum.const_31,_loc7_));
            }
            _loc4_++;
         }
         _loc9_ = _container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_29);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = _container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.const_29);
            if(_loc8_ != null)
            {
               ...
               _loc3_.push(new ChooserItem(_loc8_.getId(),RoomObjectCategoryEnum.const_29,_loc7_));
            }
            _loc4_++;
         }
         _loc3_.sort(compareItems);
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_727,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_320);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.REQUEST_FURNI_CHOOSER:
               ...
               break;
            case RoomWidgetRoomObjectMessage.const_320:
