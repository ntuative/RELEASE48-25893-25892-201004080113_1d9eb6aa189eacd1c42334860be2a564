package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_539);
         _loc1_.push(RoomWidgetChatTypingMessage.const_603);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_539:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_603:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_678,HabboToolbarIconEnum.CHATINPUT,param1));
