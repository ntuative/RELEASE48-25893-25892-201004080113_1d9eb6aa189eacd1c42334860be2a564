package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_170:DesktopLayoutManager;
      ...
      private var var_35:IRoomSession = null;
      ...
      private var var_776:IHabboHelp = null;
      ...
      private var var_775:IRoomWidgetFactory = null;
      ...
      private var var_573:IAvatarRenderManager = null;
      ...
      private var var_342:ISessionDataManager = null;
      
      private var var_1974:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_200 = new Map();
         var_170 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_286,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_352,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_689,onRoomContentLoaded);
         }
      }
      ...
      {
         if(_roomEngine != null && var_35 != null)
         {
            var_696 = _roomEngine.loadRoomResources(var_35.roomResources);
            if(false)
            {
               var_1244 = false;
         ...
         {
            var_1243 = !var_247.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_35.roomId,var_35.roomCategory,var_268[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_200 != null)
         {
            ...
            {
               _loc5_ = var_200.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_286,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_352,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_689,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_17 = null;
         var_775 = null;
         ...
         if(var_201 && false)
         {
            var_201.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_201.events.removeEventListener(HabboToolbarEvent.const_57,onHabboToolbarEvent);
         }
         var_201 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1974);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_200.length)
         {
            _loc2_ = var_200.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_170.setLayout(param1,_windowManager);
         if(var_201 != null)
         {
            var_170.toolbarSize = var_201.size;
            var_170.toolbarOrientation = var_201.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.setActiveRoom(var_35.roomId,var_35.roomCategory);
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_775.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_170.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_200.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_170.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_170 != null)
         {
            var_170.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_521:
               ...
               if(var_648 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_35.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_393)
                  {
                     var_648.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_238:
               switch(_loc3_)
               {
               ...
               break;
            case RoomEngineObjectEvent.const_682:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_31:
                  case RoomObjectCategoryEnum.const_29:
            ...
            case RoomEngineObjectEvent.const_123:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_535,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_127:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_510,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_115:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_550,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_125:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_813,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_435:
               ...
               break;
            case RoomEngineObjectEvent.const_479:
            case RoomEngineObjectEvent.const_430:
               handleRoomAdTooltip(param1);
               break;
            case RoomEngineObjectEvent.const_89:
               processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_200.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_170.roomViewRect;
         ...
         if(var_35 == null || _windowManager == null || _roomEngine == null)
         {
            return;
         }
         var _loc6_:DisplayObject = _roomEngine.createRoomCanvas(var_35.roomId,var_35.roomCategory,param1,_loc3_,_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:RoomGeometry = _roomEngine.getRoomCanvasGeometry(var_35.roomId,var_35.roomCategory,param1) as RoomGeometry;
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_590);
            _loc13_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_721);
            _loc14_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_677);
            _loc15_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_598);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_35 != null)
            {
               _loc2_ = _roomEngine.getRoomCanvasGeometry(var_35.roomId,var_35.roomCategory,getFirstCanvasId());
               if(_loc2_ != null)
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_479:
               ...
               var_171 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_283,WindowStyle.const_333,WindowParam.const_86) as IToolTipWindow;
               var_171.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_696 == null || false)
         {
            return;
         }
         var _loc2_:int = var_696.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_696.splice(_loc2_,1);
         }
         if(false)
         {
            var_1244 = true;
      ...
      {
         if(var_17 != null && var_35 != null && var_1243 && var_1244)
         {
            var_17.startSession(var_35);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_234));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_170.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
