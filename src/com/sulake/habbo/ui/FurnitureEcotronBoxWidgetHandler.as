package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_77,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_550,RoomWidgetEcotronBoxOpenMessage.const_568,RoomWidgetEcotronBoxOpenedMessage.const_1171];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_262:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_77,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_550:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_568:
