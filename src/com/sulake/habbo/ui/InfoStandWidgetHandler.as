   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_149,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_116,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_142,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.PET_INFO,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_149,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_116,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_142,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.PET_INFO,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_582);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_309);
                  if(param1.category == RoomObjectCategoryEnum.const_31)
                  {
                     _loc23_ = _container.sessionDataManager.getFloorItemData(_loc22_);
                  }
                  else if(param1.category == RoomObjectCategoryEnum.const_29)
                  {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_854);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_821);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_322)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_393)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_958)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_607);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_217)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_224)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_663);
                     _loc13_.hasFlatControl = _loc30_ == "onlyfurniture" || _loc30_ == "useradmin" || _loc30_ == "";
                     _loc13_.method_3 = _container.roomSession.isPrivateRoom;
                  }
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1378;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_836;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1013;
                  }
               ...
               {
                  _loc13_.method_3 = _container.roomSession.isRoomOwner;
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1305);
               }
               else
               {
               ...
               if(_loc18_ != null)
               {
                  _loc18_.setDirection(AvatarSetType.const_38,4);
                  _loc13_.image = _loc18_.getImage(AvatarSetType.const_38);
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_557.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_557.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_36);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_663);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_114];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_282);
         _loc1_.push(RoomWidgetUserActionMessage.const_734);
         _loc1_.push(RoomWidgetUserActionMessage.const_547);
         _loc1_.push(RoomWidgetUserActionMessage.const_511);
         _loc1_.push(RoomWidgetUserActionMessage.const_571);
         _loc1_.push(RoomWidgetUserActionMessage.const_523);
         _loc1_.push(RoomWidgetUserActionMessage.const_372);
         _loc1_.push(RoomWidgetUserActionMessage.const_542);
         _loc1_.push(RoomWidgetUserActionMessage.const_620);
         _loc1_.push(RoomWidgetUserActionMessage.const_553);
         _loc1_.push(RoomWidgetUserActionMessage.const_572);
         _loc1_.push(RoomWidgetUserActionMessage.const_508);
         _loc1_.push(RoomWidgetFurniActionMessage.const_245);
         _loc1_.push(RoomWidgetFurniActionMessage.const_545);
         _loc1_.push(RoomWidgetFurniActionMessage.const_604);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_601);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_645);
         _loc1_.push(RoomWidgetUserActionMessage.const_447);
         _loc1_.push(RoomWidgetUserActionMessage.const_703);
         _loc1_.push(RoomWidgetUserActionMessage.const_499);
         _loc1_.push(RoomWidgetUserActionMessage.const_1273);
         _loc1_.push(RoomWidgetPetCommandMessage.const_546);
         _loc1_.push(RoomWidgetPetCommandMessage.const_587);
         _loc1_.push(RoomWidgetUserActionMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_381);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_114:
      ...
      public function dispose() : void
      {
         ...
         if(var_557 != null)
         {
            _loc1_ = var_557.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_557.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return RoomWidgetEnum.const_390;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_447)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_282:
               return handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_734:
            ...
            case RoomWidgetUserActionMessage.const_665:
               ...
               break;
            case RoomWidgetUserActionMessage.const_511:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_939,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_523:
               ...
               break;
            case RoomWidgetUserActionMessage.const_372:
               _container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_542:
               _container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_620:
            ...
            case RoomWidgetRoomTagSearchMessage.const_601:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_645:
            ...
            case RoomWidgetUserActionMessage.const_703:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_587:
