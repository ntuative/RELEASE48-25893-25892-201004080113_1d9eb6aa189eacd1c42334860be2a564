package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_441,RoomWidgetPollMessage.const_614];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_130:
               ...
               break;
            case RoomSessionPollEvent.const_63:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_63);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_126:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_126);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_614:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionPollEvent.const_63);
         _loc1_.push(RoomSessionPollEvent.const_126);
         return _loc1_;
      }
