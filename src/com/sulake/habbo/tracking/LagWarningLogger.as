package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1218 || var_1591 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1590 == 0 || _loc1_ - var_1590 > var_1591)
         {
            if(_connection != null)
            {
      ...
      {
         var_1218 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1591 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
