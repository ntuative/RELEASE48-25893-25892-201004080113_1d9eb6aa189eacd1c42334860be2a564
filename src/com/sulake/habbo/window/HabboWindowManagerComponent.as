package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_343:uint = 3;
      ...
      private var var_641:ISkinContainer;
      ...
      private var var_1256:ProfilerAgentTask;
      
      private var var_1255:IEventDispatcher;
      
      private var var_2373:uint = 0;
      
      private var var_1254:ProfilerAgentTask;
      
      private var var_1257:ProfilerOutput;
      
      private var var_703:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1255 = Component(param1).events;
         var_415 = new Array();
      ...
      {
         return var_232[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_232[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_641 = new SkinContainer(_loc3_.content as XML,assets);
         var_703 = new WindowRenderer(var_641);
         var_232 = new Array(const_343);
         var _loc5_:int = 0;
         while(_loc5_ < const_343)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_703,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_232[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_232[const_1108];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_289,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1237,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_232[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_232.pop()).dispose();
            }
            var_232 = null;
            while(false)
            {
      ...
      {
         return var_232[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_415[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_415[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1257 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1257 = new ProfilerOutput(_loc3_,this,var_703);
               var_1256 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1256);
               var_1254 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1254);
               var_1040 = true;
            }
         }
      }
      ...
      {
         return var_641.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_934.length > 0)
         {
            var_1255.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_343 - 1;
            while(_loc2_ >= 0)
            {
               var_232[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1040)
         ...
         var_1255.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_343)
         {
            var_232[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1040)
         {
         ...
         if(WindowContext.var_934.length > 0)
         {
            WindowContext.var_934.flush();
         }
         if(WindowContext.var_1373.length > 0)
         {
            WindowContext.var_1373.flush();
         }
         var_1255.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1283,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1320,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1347,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1247,param2.name + ": " + param2.toString());
            }
         }
      }
   }
