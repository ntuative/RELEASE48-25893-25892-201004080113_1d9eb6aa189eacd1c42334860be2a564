package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1462:ICoreWindowManager;
      ...
      {
         var_1462 = param2 as ICoreWindowManager;
         _window = var_1462.create("Logger::Output",HabboWindowType.const_370,WindowStyle.const_333,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_340 = var_1462.create("Logger::Output::Text",HabboWindowType.const_2,WindowStyle.const_333,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
