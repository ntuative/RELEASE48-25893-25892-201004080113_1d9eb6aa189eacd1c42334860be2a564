package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_875:IgnoredUsersManager;
      
      private var var_817:Dictionary;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1052:HabboGroupInfoManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1052 = new HabboGroupInfoManager(this,events);
         var_875 = new IgnoredUsersManager(this);
      ...
      private function onProductsReady(param1:Event = null) : void
      {
         ...
         var_1050 = new FurnitureDataParser(_loc2_,var_596,var_480,var_421,_localization);
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_147.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1051 = new ProductDataParser(_loc2_,var_817);
      ...
      {
         return var_1052.getBadgeId(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         var_875.unignoreUser(param1);
      }
      ...
      {
         return var_1271.getBadgeImage(param1,BadgeImageManager.const_830);
      }
      ...
      {
         return var_1052.getGroupDetails(param1);
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_421.getValue(param1)));
      }
      ...
      {
         return var_875.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_2046 = _loc2_.isOpen;
         var_2047 = _loc2_.onShutDown;
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = var_1052.getGroupDetails(param1);
         if(_loc2_ != null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            var_730 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_430));
         }
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_421.getValue(param1)));
      }
      
      public function ignoreUser(param1:String) : void
      {
         var_875.ignoreUser(param1);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1052.communication = _communication;
         var_875.registerMessageEvents();
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_596.getValue(param1.toString());
      }
      ...
      public function getWallItemData(param1:int) : IFurnitureData
      {
         ...
         return var_480.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1271 = new BadgeImageManager(_loc1_,events,var_147,_localization);
      }
