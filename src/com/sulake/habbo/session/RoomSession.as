package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_31:String = "RSE_CREATED";
      
      private var var_971:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_323 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_94;
            if(isPrivateRoom)
            {
      ...
      {
         return var_971 as IUserDataManager;
      }
