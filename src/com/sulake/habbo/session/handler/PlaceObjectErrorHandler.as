package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_203:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_229:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_231:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_160:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_226:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_204:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_198:
               _loc4_ = "null";
               break;
            default:
               return;
