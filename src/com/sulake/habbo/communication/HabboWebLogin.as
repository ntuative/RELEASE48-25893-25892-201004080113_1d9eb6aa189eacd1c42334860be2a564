package com.sulake.habbo.communication
{
   ...
   public class HabboWebLogin extends EventDispatcher implements IHabboWebLogin
   {
      ...
      public function HabboWebLogin(param1:String, param2:String, param3:String, param4:IEventDispatcher = null)
      {
         ...
         _name = param1;
         _password = param2;
         var_2028 = "https://" + param3 + "/account/submit";
         var_2027 = "https://" + param3 + "/security_check";
         var_2029 = "https://" + param3 + "/account/reauthenticate";
      }
      
      private function securityCheckComplete(param1:Event = null) : void
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_15.removeEventListener(Event.COMPLETE,securityCheckComplete);
         removeListeners(var_15);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
            dispatchEvent(new Event(HabboWeb.const_199));
         }
      }
      ...
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_15.removeEventListener(Event.COMPLETE,credentialsComplete);
         removeListeners(var_15);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
      ...
      {
         var _loc1_:URLRequest = new URLRequest(var_2027);
         var_15 = new URLLoader();
         var_15.addEventListener(Event.COMPLETE,securityCheckComplete);
         configureListeners(var_15);
         var_15.load(_loc1_);
      }
      ...
      public function requestReAuthenticate() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(var_2029);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         var_15 = new URLLoader();
         var_15.addEventListener(Event.COMPLETE,reauthenticateComplete);
         configureListeners(var_15);
         var_15.load(_loc2_);
      }
      ...
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_15.removeEventListener(Event.COMPLETE,reauthenticateComplete);
         removeListeners(var_15);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
      ...
      private function requestCredentials() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(var_2028);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         var_15 = new URLLoader();
         var_15.addEventListener(Event.COMPLETE,credentialsComplete);
         configureListeners(var_15);
         var_15.load(_loc2_);
      }
