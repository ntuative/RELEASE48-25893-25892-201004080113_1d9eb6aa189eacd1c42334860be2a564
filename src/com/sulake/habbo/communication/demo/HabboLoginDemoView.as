package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_576:String = "InitConnection";
      ...
      private var var_339:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_107:SSOTicket;
      ...
      {
         var_339.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_339.shockwaveClientUrl = var_107.shockwaveClientUrl;
         var_339.ssoTicket = var_107.ticket;
         var_107.removeEventListener(SSOTicket.const_328,onParsedTicketSuccess);
         var_107.removeEventListener(SSOTicket.const_233,onParsedTicketFailure);
         var_107 = null;
         dispatchEvent(new Event(const_576));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1414,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_339 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_339.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_370,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_339.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_97,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1414,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_339.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_339.habboCommunication.habboWebLogin(name,password);
         var_107 = new SSOTicket(var_339.assets,_loc2_,_loc1_);
         var_107.addEventListener(SSOTicket.const_328,onParsedTicketSuccess);
         var_107.addEventListener(SSOTicket.const_233,onParsedTicketFailure);
      }
