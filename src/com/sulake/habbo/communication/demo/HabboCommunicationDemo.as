package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1982:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1490:ILogger;
      
      private var var_1249:String;
      
      private var var_1980:String;
      
      private const const_1414:String = "fuselogin";
      
      private var var_298:ICoreCommunicationManager;
      
      private var var_414:IKeyExchange;
      ...
      private var var_62:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1211:
            case DisconnectReasonEvent.const_1369:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1213:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1242:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1981)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_700 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_700);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_150);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_1037 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_219);
         param1.send(new VersionCheckMessageComposer(401,var_1249,var_1980));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1414,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_414.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_414.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1982);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1414,"/");
      ...
      {
         var_700 = _habboConfiguration.getKey("sso.ticket",null);
         var_1249 = _habboConfiguration.getKey("flash.client.url","");
         var_1980 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_172 == null)
         {
         ...
         if(var_700 != null)
         {
            var_62.mode = HabboConnectionType.const_417;
            var_62.initConnection(HabboConnectionType.const_271);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1490 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_62 = param2 as IHabboCommunicationManager;
            _loc3_ = var_62.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_62.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_62.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_62.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_62.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_62.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_62.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_62.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_62.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_62.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_62.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_62.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_62.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_62.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_512);
            _loc3_ = new InitCryptoMessageComposer(var_62.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1982 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_62.mode)
         {
            case HabboConnectionType.const_417:
               _loc6_ = "";
               ...
               var_1038 = _loc4_;
               var_172.loadBannerImage(_loc7_ + "?token=" + var_1038,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_898:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1310:
               var_580 = generateRandomHexString(30);
               var_414 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_414.init(var_580);
               _loc8_ = var_414.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1038);
         ...
         var _loc9_:IConnection = var_62.getHabboMainConnection(null);
         ...
         var_414 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_414.init(_loc14_);
            _loc15_ = var_414.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_898;
            }
         }
         var_62.initConnection(HabboConnectionType.const_271);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_200);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_156,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_100,onRoomSessionEnded);
      }
