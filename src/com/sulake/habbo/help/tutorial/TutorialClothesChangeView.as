package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private var var_553:IWindowContainer;
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         _main.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
         _main.prepareForTutorial();
      }
      
      public function get id() : String
      {
         return TutorialUI.const_319;
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_553 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_553.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU_ARROW,var_553));
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_47)
         {
            ...
            _main.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_404));
         }
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      {
         setToolbarIconHighlight(false);
         _main.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      }
   }
}
