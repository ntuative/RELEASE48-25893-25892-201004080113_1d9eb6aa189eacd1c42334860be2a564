package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1497:uint = 13232628;
      
      private static var var_2012:uint = 11129827;
      ...
      private var var_272:IBorderWindow;
      
      private var var_868:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_346);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_346);
         }
         if(var_272 == null)
         {
            var_272 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_272 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_272);
            var_272.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_272.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_929:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1100:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1099 || param1 == ChangeUserNameResultMessageEvent.var_1100)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_868 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_868.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1497;
