package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1114:int = 0;
      
      private static const const_344:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_714 == null || _loc3_ < 0 || _loc3_ >= var_714.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_714[_loc3_];
            main.showUI(HabboHelpViewEnum.const_708);
            main.tellUI(HabboHelpViewEnum.const_708,null);
         }
      }
   }
}
