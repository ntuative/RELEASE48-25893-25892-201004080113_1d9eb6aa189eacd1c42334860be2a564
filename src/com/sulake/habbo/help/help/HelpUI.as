package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1432:int = 0;
      
      private static const const_1433:int = 0;
      ...
      private var var_2219:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25893-25892-201004080040");
         var_201 = param5;
         var_100 = new Map();
         var_100.add(HabboHelpViewEnum.const_1264,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_146,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_422,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_264,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_212,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_538,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_317,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_708,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_228,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_100.add(HabboHelpViewEnum.const_1008,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_722,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1586 = 0 - _loc3_.width;
         var_1587 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_279 == HabboHelpViewEnum.const_146 || false)
         {
            return;
         }
         if(var_438 == null)
         {
            ...
            var_438 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_438 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_438 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_438 as IWindow);
      ...
      {
         return var_100.getValue(var_279);
      }
      
      public function get localization() : IHabboLocalizationManager
      {
         return var_22.localization;
      }
      ...
      {
         var_2218 = param1;
         var _loc2_:IHelpViewController = var_100.getValue(HabboHelpViewEnum.const_146) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_228:
               showUI(HabboHelpViewEnum.const_228);
               break;
            case CallForHelpResultEnum.const_935:
               showUI(HabboHelpViewEnum.const_1008);
               break;
            case CallForHelpResultEnum.const_938:
      ...
      {
         var _loc3_:* = null;
         if(var_279 == HabboHelpViewEnum.const_146)
         {
            return;
         }
         if(true)
         {
            ...
            var_614.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_614.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_438.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_614[1],var_614[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_614[0],var_614[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1587;
         _window.width = _loc1_.width + var_1586;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_279);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_201 != null)
            {
               var_201.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
         var_22.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT));
      }
      ...
      public function hideUI() : void
      {
         ...
         var_279 = var_2219;
         var_22.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED));
      }
      
      public function sendMessage(param1:IMessageComposer) : void
      {
         var_22.sendMessage(param1);
      }
      
      public function getFaq() : FaqIndex
      {
         return var_22.getFaq();
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_667));
      }
      ...
      {
         return var_22.getConfigurationKey(param1,param2,param3);
      }
   }
}
