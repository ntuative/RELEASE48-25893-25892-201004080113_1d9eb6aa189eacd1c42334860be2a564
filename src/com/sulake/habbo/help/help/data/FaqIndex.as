package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_635:FaqCategory;
      ...
      {
         var _loc4_:* = null;
         if(var_636.hasItem(param1))
         {
            var_636.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_635.hasItem(param1))
         {
            var_635.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_117.length)
         {
            _loc4_ = var_117.getWithIndex(_loc3_);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_117.length)
            {
               _loc2_ = var_117.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
            var_117.dispose();
      ...
      {
         if(param1 >= var_117.length)
         {
            return null;
         }
         return var_117.getWithIndex(param1);
      }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(var_635.hasItem(param1))
         {
            return var_635.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < var_117.length)
         {
            _loc3_ = var_117.getWithIndex(_loc2_);
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < var_117.length)
         {
            _loc2_ = var_117.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
