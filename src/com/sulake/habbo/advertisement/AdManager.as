package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_887:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_467,0,0,_loc4_,var_1523,var_887,var_886));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2080 = int(_config.getKey("interstitial.interval","30000"));
         var_2078 = int(_config.getKey("interstitial.show.time","5000"));
         var_1524 = int(_config.getKey("interstitial.max.displays.flash","-1"));
         ...
         if(_loc3_ != "" && _loc4_ != "")
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_34,adWarningLeftReady);
            _loc6_ = new URLRequest(_loc4_);
            _loc7_ = _assets.loadAssetFromFile("adWarningRight",_loc6_,"image/png");
            _loc7_.addEventListener(AssetLoaderEvent.const_34,adWarningRightReady);
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1288 = _loc2_.imageUrl;
         var_1523 = _loc2_.clickUrl;
         if(var_1288 != "" && var_1523 != "")
         {
            _loc3_ = var_1288;
            ...
            _loc4_ = new URLRequest(var_1288);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_34,roomAdImageReady);
         }
      }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1289 = _loc2_.imageUrl;
         var_2079 = _loc2_.clickUrl;
         var_720 = getTimer();
         if(var_1289 != "")
         {
            _loc3_ = var_1289;
            ...
            if(var_236 == null)
            {
               var_236 = new Timer(var_2078,1);
               var_236.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_236.reset();
            ...
            var_236.start();
            _loc4_ = new URLRequest(var_1289);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_34,interstitialLoaderEventHandler);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_431,0,0,param1.bitmapData,var_2079));
            var_720 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_886 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1524 > 0 && var_1525 >= var_1524)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_720;
         if(_loc1_ > var_2080)
         {
            ++var_1525;
      ...
      {
         var_298 = param2 as IHabboCommunicationManager;
         if(var_298 == null)
         {
            return;
         }
         _connection = var_298.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_351));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_887 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
