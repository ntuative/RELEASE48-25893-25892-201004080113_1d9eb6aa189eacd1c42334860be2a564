package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_772:String = "selection_arrow";
      
      private static const const_774:String = "tile_cursor";
      
      private static const const_276:String = "RCL_PUBLICROOM_";
      
      private static const const_488:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_342:String = "place_holder";
      
      private static const const_1072:String = const_342;
      
      private static const const_1419:int = 0;
      
      private static const const_773:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_687:String = "RCL_LOADER_READY";
      ...
      private var var_1017:IEventDispatcher = null;
      
      private var var_1193:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_482 = [];
         var_480 = [];
         var_1886 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1885 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_402 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_482.indexOf(_loc4_) == -1)
                     {
                        var_482.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_29:
                     if(var_480.indexOf(_loc4_) == -1)
                     {
                        var_480.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_286,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_403 != null)
         {
            _loc2_ = var_403.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_276 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_165 != null && var_165.hasWorldType(const_276 + param1))
         {
            return var_165.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_481.add(_loc10_,_loc11_);
                              if(var_482.indexOf(_loc14_) < 0)
                              {
                                 var_482.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_480.indexOf(_loc14_) < 0)
                              {
                                 var_480.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_402 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_402.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_402.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_566.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_402.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_342,const_488,ROOM_CONTENT,const_774,const_772];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_31 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1886.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_179 && _loc5_ != RoomObjectLogicEnum.const_118)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_481.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_482.indexOf(param1) >= 0)
         {
            return const_342;
         }
         if(var_480.indexOf(param1) >= 0)
         {
            return const_488;
         }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_567.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1290);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1885.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1193.add(_loc5_,_loc8_);
               var_165 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_286,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_352,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1889)
         {
            ...
            if(var_1017 != null)
            {
               var_1017.dispatchEvent(new Event(const_687));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_165 != null)
         {
            return var_165.getWorldHeightScale(const_276 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.const_31 || _loc3_ == RoomObjectCategoryEnum.const_29)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_34,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_44,furniDataLoadedHandler);
            var_1017 = param1;
            var_1887 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1890 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1888 = param2.getKey("public.room.dynamic.download.url","");
            var_1884 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_773;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_403 != null)
         {
            var_403.remove(param2);
            var_403.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_179 && _loc5_ != RoomObjectVisualizationEnum.const_118)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_276 + param1) == RoomObjectCategoryEnum.const_62)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1193.getValue(param1) != null)
         {
            var_165 = var_1193.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_464,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_165 != null)
         {
            return var_165.getWorldScale(const_276 + param1);
         }
         return 32;
      }
