package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_494:String = "room";
      
      private static const const_787:int = -2;
      
      private static const const_493:String = "temporary_room";
      
      private static const const_277:String = "object_icon_sprite";
      ...
      private static const const_1129:String = "tile_cursor";
      ...
      private var var_315:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_247:IAdManager = null;
      ...
      private var var_746:RoomMessageHandler = null;
      
      private var var_747:IRoomRendererFactory = null;
      
      private var var_2215:Boolean = false;
      
      private var var_111:int = 0;
      
      private var var_1087:Map;
      
      private var _communication:IHabboCommunicationManager = null;
      
      private var var_112:int = 0;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_746 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_63 != null)
         {
            ...
            {
               return var_63.deleteWallItem(var_112,var_111,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_314.length; _loc2_++)
         {
            _loc3_ = var_314.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_590) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_677) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_721) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_598) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_63.modifyWallItemData(var_112,var_111,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_417 != null)
         {
            var_417.release(new IIDRoomObjectVisualizationFactory());
            var_417 = null;
         }
         if(var_39 != null)
         {
         ...
         if(var_747 != null)
         {
            var_747.release(new IIDRoomRendererFactory());
            var_747 = null;
         }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_314.length)
            {
               _loc2_ = var_314.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_747.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1019;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_664);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_636);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_573);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_927);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_971);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_945) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_904);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_399,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_588,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_682,var_112,var_111,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_63 != null)
         {
            return var_63.modifyRoomObject(var_112,var_111,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_315.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_315.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_515,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_505,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_39 != null)
         {
            ...
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_36);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_39.addObjectUpdateCategory(RoomObjectCategoryEnum.const_62);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_63 != null)
         {
            var_63.handleRoomObjectEvent(param1,var_112,var_111);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_221,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_309,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_295,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_969,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_854,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_821,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_238,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_608,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_26 == null || var_417 == null || var_39 == null || var_747 == null || _communication == null || _habboConfiguration == null || !var_2215)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_278,RoomObjectCategoryEnum.const_62);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1341,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_39.getRoom(getRoomIdentifier(var_112,var_111));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_111,var_1347);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_277);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_111,var_1347);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_277);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_417 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_417;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_201,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_445,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_251,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_619,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_111,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_115,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_89,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_444,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_470,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_443,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_474,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_452,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_385,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_64,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_440,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_364,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_265,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_426,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_299,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_308,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_406,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_873,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_349,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_402,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_205;
      }
      
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         var _loc5_:IRoomInstance = getRoom(var_112,var_111);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_684) != 0)
         {
            return false;
         }
         if(var_63 != null)
         {
            return var_63.initializeRoomObjectInsert(var_112,var_111,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_517 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_688,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_315.length)
            {
               _loc3_ = var_315.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_36;
         }
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_238,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
      ...
      {
         disposeObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_36);
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_221));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_386);
                     break;
                  case RoomObjectCategoryEnum.const_36:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_177);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_326);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_687)
         {
            var_2215 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_221,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_309,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_295,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1019,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_238,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_247.events.addEventListener(AdEvent.const_467,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_314.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_716,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_747 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      
      private function getObjectUser(param1:int, param2:int, param3:int) : IRoomObjectController
      {
         return getObject(getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_36);
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_517 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_39.getRoom(const_493);
         if(_loc10_ == null)
         {
            _loc10_ = var_39.createRoom(const_493,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_221,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_386,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_177,param2);
               break;
            case RoomObjectCategoryEnum.const_62:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_135,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_138,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_138,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_658,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_559,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_653,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_399,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1087.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_846,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_787,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_111,param1);
         if(_loc9_ != null)
         {
            var_1347 = param1;
            var_1581 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_277);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1581 - _loc12_.width / 2;
               _loc11_.y = var_1582 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_369,var_112,var_111,-1,RoomObjectCategoryEnum.const_205));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_63 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_278,const_494);
                  var_63.handleRoomObjectEvent(_loc14_,var_112,var_111);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_112,var_111,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
            ...
            if(param2 == RoomObjectCategoryEnum.const_36)
            {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_112,var_111,var_1347);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_277);
            _loc11_ = addOverlayIconSprite(_loc10_,const_277,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1581 - _loc6_.data.width / 2;
               _loc11_.y = var_1582 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_280,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_798,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_799,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_892,RoomObjectVariableEnum.const_280,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_314.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_314.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_687,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_63 != null)
         {
            var_63.cancelRoomObjectInsert(var_112,var_111);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_39.getRoom(const_493);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_846);
               ...
               _loc13_ = var_1087.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_112,var_111,const_278,RoomObjectCategoryEnum.const_62,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_278,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_992,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_684,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_825,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_278,const_494,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_684,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_664,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_590,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_721,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_677,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_598,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_899,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_515,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_505,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_399,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_213);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_636,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_573,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_636,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_573,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_927,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_971,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_787,const_1129,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_788,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
