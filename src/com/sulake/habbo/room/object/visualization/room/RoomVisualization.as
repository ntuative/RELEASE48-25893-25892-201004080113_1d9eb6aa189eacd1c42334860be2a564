package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1143:int = 13421772;
      
      private static const const_768:int = 16777215;
      
      public static const const_1371:int = 10066329;
      
      private static const const_767:int = 13421772;
      
      public static const const_1386:int = 16777215;
      
      private static const const_1415:int = 0;
      
      public static const const_1385:int = 16777215;
      
      private static const const_770:int = 10066329;
      
      private static const const_769:int = 10066329;
      ...
      private var var_1275:String = null;
      ...
      private var var_1785:int = -1000;
      
      private var var_1007:uint = 16777215;
      
      private var var_1848:Boolean = true;
      ...
      private var var_563:Rectangle = null;
      
      private var var_1852:int = 255;
      
      private var var_1849:Boolean = false;
      
      private var var_1844:int = 255;
      
      private var var_1850:String = null;
      
      private const const_1631:int = 250;
      ...
      private var var_398:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_398 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_73.planeCount)
         {
            _loc3_ = var_73.getPlaneType(_loc2_);
            if(_loc3_ == RoomPlaneData.const_249)
            {
               _loc4_ = var_73.getPlaneRightSide(_loc2_);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_903);
         if(!var_73.initializeFromXML(new XML(_loc2_)))
         {
            return;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_899);
         var _loc7_:int = 0;
         while(_loc7_ < var_73.planeCount)
         {
            _loc8_ = var_73.getPlaneLocation(_loc7_);
            _loc9_ = var_73.getPlaneLeftSide(_loc7_);
            _loc10_ = var_73.getPlaneRightSide(_loc7_);
            _loc11_ = var_73.getPlaneSecondaryNormals(_loc7_);
            _loc12_ = var_73.getPlaneType(_loc7_);
            _loc13_ = null;
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_188,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_138)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_223,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_189,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1208)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_223,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
            ...
            if(_loc13_ != null)
            {
               ...
               _loc15_ = 0;
               while(_loc15_ < var_73.getPlaneMaskCount(_loc7_))
               {
                  _loc16_ = var_73.getPlaneMaskLeftSideLoc(_loc7_,_loc15_);
                  _loc17_ = var_73.getPlaneMaskRightSideLoc(_loc7_,_loc15_);
                  _loc18_ = var_73.getPlaneMaskLeftSideLength(_loc7_,_loc15_);
                  _loc19_ = var_73.getPlaneMaskRightSideLength(_loc7_,_loc15_);
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_223 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_563 == null)
         {
            var_563 = super.boundingRectangle;
         }
         return new Rectangle(var_563.x,var_563.y,var_563.width,var_563.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_398.maskCount)
         {
            _loc6_ = var_398.getMaskType(_loc5_);
            _loc7_ = var_398.getMaskLocation(_loc5_);
            _loc8_ = var_398.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_103.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_223 || _loc3_.type == RoomPlane.const_189 && _loc8_ == RoomPlaneBitmapMaskData.const_213)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1463;
                        if(var_73.getPlaneType(_loc9_) == RoomPlaneData.const_135)
                        {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_73.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_249)
            {
               _loc4_ = var_73.getPlaneLeftSide(_loc2_);
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1268)
         {
            var_1268 = param1.updateId;
            var_563 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1047 || _loc9_.y != var_1846 || _loc9_.z != var_1847 || param1.scale != var_1845))
            {
               var_1047 = _loc9_.x;
               var_1846 = _loc9_.y;
               var_1847 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_970);
            if(_loc10_ != var_1850)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_543));
            if(_loc11_ != var_1007)
            {
               var_1007 = _loc11_;
               var_1844 = var_1007 & 255;
               var_1852 = var_1007 >> 8 & 255;
               var_1851 = var_1007 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1785 + const_1631 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1785 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            ...
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_658);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_653);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1848 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_944));
            var_161 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_397.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_397[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_189)
            {
               if(var_1848)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1844 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1852 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1851 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_103.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_188 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_223 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_189 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
