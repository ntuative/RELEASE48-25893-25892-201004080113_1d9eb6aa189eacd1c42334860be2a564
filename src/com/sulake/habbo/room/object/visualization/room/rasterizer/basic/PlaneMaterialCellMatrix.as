package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1277:int = const_334;
      
      public static const const_190:int = 2;
      
      public static const const_206:int = 3;
      ...
      public static const const_215:int = 4;
      
      public static const const_526:int = 6;
      
      public static const ALIGN_DEFAULT:int = const_103;
      ...
      private var var_1128:Boolean = true;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_328[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      {
         if(param1 == null || var_23 == null || param1 == var_23)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(var_1406 == const_103)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_329);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_329,var_23.width,var_329);
         }
         param1.copyPixels(var_23,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_544,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_329,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
         ...
         {
            if(var_23.width == param2 && var_23.height == param3)
            {
         ...
         if(!param5)
         {
            ...
            if(var_23 == null)
            {
               var_23 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               var_23.fillRect(var_23.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_328.length)
         {
            _loc11_ = var_328[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         {
            case const_222:
               _loc10_ = renderRepeatBorders(var_23,_loc8_);
               break;
            case const_206:
               _loc10_ = renderRepeatCenter(var_23,_loc8_);
               break;
            case const_215:
               _loc10_ = renderRepeatFirst(var_23,_loc8_);
               break;
            case REPEAT_MODE_LAST:
               _loc10_ = renderRepeatLast(var_23,_loc8_);
               break;
            case const_526:
               _loc10_ = renderRepeatRandom(var_23,_loc8_);
               break;
            default:
               _loc10_ = renderRepeatAll(var_23,_loc8_);
         }
         var_329 = _loc10_;
         if(param1 != null)
         {
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_328[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_328.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_328[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_328[param1] = _loc5_;
