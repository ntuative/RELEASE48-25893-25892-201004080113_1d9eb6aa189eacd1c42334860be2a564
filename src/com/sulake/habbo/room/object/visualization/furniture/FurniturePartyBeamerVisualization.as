package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_765:int = 15;
      
      private static const const_1068:int = 2;
      
      private static const const_338:int = 2;
      
      private static const const_766:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1001[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1003[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1001 = new Array();
         var_1001.push(Math.random() * _loc2_ * 1.5);
         var_1001.push(Math.random() * _loc2_ * 1.5);
         var_1004 = new Array();
         var_1004.push(1);
         var_1004.push(-1);
         var_1002 = new Array();
         var_1002.push(const_1068);
         var_1002.push(const_1067);
         var_1003 = new Array();
         var_1003.push(getRandomAmplitudeFactor());
         var_1003.push(getRandomAmplitudeFactor());
      }
