package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_458,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_280,"");
         _loc2_.setString(RoomObjectVariableEnum.const_602,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_458,Number(false));
         var_779 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_892:
                  _loc2_.setString(RoomObjectVariableEnum.const_280,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_602,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_458,Number(true));
                  var_947 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_825);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_449)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_602);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_265,_loc5_,_loc6_,_loc7_));
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_449)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_299,_loc5_,_loc6_));
               }
               break;
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_449)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_308,_loc5_,_loc6_));
               }
         }
      }
   }
