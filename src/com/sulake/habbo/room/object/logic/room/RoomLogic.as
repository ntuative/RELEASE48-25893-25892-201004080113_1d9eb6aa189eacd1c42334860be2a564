package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1585:int = 1500;
      
      private var var_1583:int = 255;
      
      private var var_1584:int = 255;
      
      private var var_1349:uint = 16777215;
      
      private var var_1088:uint = 16777215;
      
      protected var var_73:RoomPlaneParser = null;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_631:
                  _loc2_.setString(RoomObjectVariableEnum.const_658,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_515:
                  _loc2_.setString(RoomObjectVariableEnum.const_559,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_505:
                  _loc2_.setString(RoomObjectVariableEnum.const_653,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_399:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_213)
                  {
                     _loc8_ = "null";
                  }
                  var_398.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_588:
                  _loc7_ = var_398.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_398.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_970,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_944,int(_loc5_.bgOnly));
            var_1349 = _color;
            var_1583 = var_1234;
            var_1088 = _loc11_;
            var_1584 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_73.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_903,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_543,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_73.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_73.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_73.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_73.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_73.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_73.getPlaneNormal(_loc5_);
         var _loc13_:int = var_73.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1282,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1136,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1253,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_135)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_138 || _loc13_ == RoomPlaneData.const_249)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_920)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_543,_loc3_);
         }
      }
   }
}
