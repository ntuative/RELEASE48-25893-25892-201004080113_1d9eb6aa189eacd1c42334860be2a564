package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_670:String = "bg";
       
      
      private var var_1819:IContainerButtonWindow;
      
      private var var_1821:IContainerButtonWindow;
      
      private var var_1818:IContainerButtonWindow;
      
      private var var_1820:IContainerButtonWindow;
      
      private var var_350:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_350 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1821 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1818 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1819 = initButton("room_invite",onInviteButtonClick,param1);
         var_1820 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_670);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_83,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_350.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_350.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_30)
         {
            this.var_350.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_241)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_241 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1821,isEnableMinimailButton(_loc1_));
         setEnabled(var_1818,isEnableHomeButton(_loc1_));
         setEnabled(var_1819,isEnableInviteButton(_loc1_));
         setEnabled(var_1820,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = var_49.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_670);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_83,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_83).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_83,param1);
      }
