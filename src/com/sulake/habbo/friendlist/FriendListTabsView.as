package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_83 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_311);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_19.width = _friendList.tabs.tabContentWidth;
         var_19.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_19.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_19.height = _loc2_ + 1;
         var_19.findChildByName("bg").height = var_19.height;
