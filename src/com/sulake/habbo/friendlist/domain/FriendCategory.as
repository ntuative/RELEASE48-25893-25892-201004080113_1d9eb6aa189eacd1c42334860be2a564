package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_473:int = -1;
      ...
      {
         return Math.ceil(this.var_233.length / const_285);
      }
      ...
      {
         if(this.var_866 >= this.getPageCount())
         {
            this.var_866 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_866 + 1) * const_285,this.var_233.length);
      }
