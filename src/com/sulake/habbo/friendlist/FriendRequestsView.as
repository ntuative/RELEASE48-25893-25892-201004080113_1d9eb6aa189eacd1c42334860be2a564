package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1427:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_305 && _loc4_.state != FriendRequest.const_310)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_305;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_52,_loc4_.requestId));
               }
            }
         }
      ...
      {
         var_1553 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1552 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1552.procedure = onDismissAllButtonClick;
         var_1553.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_305 && _loc4_.state != FriendRequest.const_310)
            {
               _loc4_.state = FriendRequest.const_310;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_235,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_144)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1553,_loc1_);
         setEnabled(var_1552,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_305;
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_52,param1));
         }
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_49.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_49.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_310;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_235,param1));
         }
      }
   }
}
