package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_153:String = "face";
      ...
      private var var_1414:OpenedToWebPopup;
      
      private var var_792:IAvatarRenderManager;
      
      private var var_201:IHabboToolbar;
      
      private var var_378:FriendListTabs;
      ...
      private var var_1415:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_793:FriendRequests;
      
      private var var_1683:int;
      
      var var_88:FriendCategories;
      
      private var var_1684:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_794:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1684 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_88 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1415 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_793.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_793.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_378.findTab(FriendListTab.const_84).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_793 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_88.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_88.addCategory(new FriendCategory(FriendCategory.const_974,getText("friendlist.friends")));
         var_88.addCategory(new FriendCategory(FriendCategory.const_473,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_88.addFriend(new Friend(_loc4_));
         }
         var_378 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_455)
         {
            var_455 = new Timer(120000);
            var_455.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_455.start();
         }
         getBuddyRequests();
         registerListeners();
         var_201.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_455.stop();
            var_455.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_455 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_131)
         {
            var_131.release(new IIDHabboMessenger());
            var_131 = null;
         }
         if(var_147)
         {
         ...
         if(var_792)
         {
            var_792.release(new IIDAvatarRenderManager());
            var_792 = null;
         }
         if(var_794)
         {
            var_794.release(new IIDHabboNotifications());
            var_794 = null;
         }
         if(var_201)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_131 = param2 as IHabboMessenger;
      ...
      {
         var_88.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_83);
      ...
      {
         var _loc1_:String = var_147.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_378.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_311));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1415.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_793.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_201.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_88.findFriend(param1);
      }
      ...
      {
         var _loc2_:FriendListTab = var_378.findTab(FriendListTab.const_84);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_792.createAvatarImage(param1,AvatarScaleType.const_96);
         return _loc2_.getCroppedImage(AvatarSetType.const_46);
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_793.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_378.findTab(FriendListTab.const_84);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_792 = param2 as IAvatarRenderManager;
      ...
      {
         var_794 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_88.getFriendCount(param1,param2);
      }
      ...
      {
         return var_147.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1414 == null)
         {
            var_1414 = new OpenedToWebPopup(this);
         }
         var_1414.show(x,y);
      }
