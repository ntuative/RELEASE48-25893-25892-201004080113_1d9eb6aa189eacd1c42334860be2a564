package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_800:String = "issue_bundle_open";
      
      public static const const_710:String = "issue_bundle_my";
      
      public static const const_1022:String = "issue_bundle_picked";
      ...
      private var var_546:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_119 = new Map();
         var_771 = new Map();
         var_546 = new IssueBrowser(this,var_58.windowManager,var_58.assets);
         var_647 = [];
         var_770 = [];
         var_960 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_960.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_119)
         {
            switch(param1)
            {
               case const_800:
                  ...
                  break;
               case const_710:
                  if(_loc4_.state == IssueMessageData.const_368 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_647 = var_647.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_771.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_771.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1183)
         {
            var_155.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_119)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_771.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_771.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_144)
         {
            ...
            _loc8_ = var_770.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_368 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_960.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_144 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_546 == null || !var_546.isOpen())
         {
            var_58.soundManager.playSound(HabboSoundTypesEnum.const_858);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_771.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_119.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_368 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
