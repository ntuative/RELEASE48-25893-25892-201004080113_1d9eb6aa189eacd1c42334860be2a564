package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1495:IMessageComposer;
      ...
      {
         var_790 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_791 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         var_399 = new Timer(300,1);
         var_399.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_52 = IFrameWindow(_main.getXmlWindow("chatlog_frame"));
         var_49 = IItemListWindow(var_52.findChildByName("chatline_list"));
         var_52.procedure = onWindow;
         var _loc1_:IWindow = var_52.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1495);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_790.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_52,_main,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
         ...
         {
            populateChatline(var_49,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         if(param1.type != WindowEvent.const_45 || param2 != var_52)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_791.clone());
         _loc4_.color = var_1147[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_52,_main,_loc6_,param2.chatterId);
         }
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(var_49.getListItemAt(_loc1_));
