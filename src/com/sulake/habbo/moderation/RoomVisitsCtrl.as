package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2166.clone());
         ...
         new OpenRoomTool(var_52,_main,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_2166 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_52 = IFrameWindow(_main.getXmlWindow("roomvisits_frame"));
         var_49 = IItemListWindow(var_52.findChildByName("visits_list"));
