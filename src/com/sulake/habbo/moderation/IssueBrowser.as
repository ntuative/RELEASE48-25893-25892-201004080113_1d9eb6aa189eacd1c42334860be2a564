package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1646:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1506:IIssueBrowserView;
      
      private const const_1653:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1647:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_235:ITabContextWindow;
      
      private var var_1507:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_235 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_235.numTabItems)
            {
               _loc5_ = var_235.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_235.selector.getSelectableByName("open_issues");
         var_235.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_349.view.width = var_235.container.width;
         var_349.view.height = var_235.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1647:
               if(var_1506 == null)
               {
                  var_1506 = new MyIssuesView(issueManager,this,var_235.container);
               }
               return var_1506;
            case const_1645:
               if(var_1505 == null)
               {
                  var_1505 = new OpenIssuesView(issueManager,this,var_235.container);
               }
               return var_1505;
            case const_1646:
               if(var_1507 == null)
               {
                  var_1507 = new PickedIssuesView(issueManager,this,var_235.container);
               }
               return var_1507;
            default:
               return null;
