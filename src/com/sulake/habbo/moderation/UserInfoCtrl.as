package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_757:int = 31536000;
      
      private static const const_759:int = 86400;
      
      private static const const_758:int = 3600;
      
      private static const const_756:int = 60;
      ...
      {
         if(param1 < 2 * const_756)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_758)
         {
            return Math.round(param1 / const_756) + " mins ago";
         }
         if(param1 < 2 * const_759)
         {
            return Math.round(param1 / const_758) + " hours ago";
         }
         if(param1 < 2 * const_757)
         {
            return Math.round(param1 / const_759) + " days ago";
         }
         return Math.round(param1 / const_757) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_856,_data.userId),_callerFrame,var_981,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_809.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_809.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1282),_callerFrame,var_981,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_981,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1282),_callerFrame,var_981,false,true);
      }
