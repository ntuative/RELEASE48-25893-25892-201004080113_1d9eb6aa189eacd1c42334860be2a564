package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1056:ICheckBoxWindow;
      ...
      private var var_884:IDropMenuWindow;
      
      private var var_717:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_530,_data.flatId),var_52,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_432);
         if(param1.flatId != var_432)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_432);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new UserInfoFrameCtrl(_main,_data.ownerId),var_52,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_717.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1197,_loc2_,var_424.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1056.isSelected,var_1057.isSelected,var_717.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1167);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1206);
      }
      
      public function populate() : void
      {
         var_49 = IItemListWindow(var_52.findChildByName("list_cont"));
         ...
         var_884 = IDropMenuWindow(var_52.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_884);
         var_884.procedure = onSelectTemplate;
         var_717 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_1056 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_1057 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
         ...
         _main.disableButton(_main.initMsg.bobbaFilterPermission,var_52,"bobba_filter_but");
      ...
      {
         var_52 = IFrameWindow(_main.getXmlWindow("roomtool_frame"));
         _main.messageHandler.addRoomInfoListener(this);
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_432));
         Logger.log("BEGINNING TO SHOW: " + var_432);
      }
   }
}
