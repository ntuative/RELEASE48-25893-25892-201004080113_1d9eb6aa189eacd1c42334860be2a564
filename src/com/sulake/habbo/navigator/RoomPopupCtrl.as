package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2026 = new RoomThumbnailRenderer(param1);
         var_769 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_173,var_108.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_769.refreshTags(_loc1_,var_108.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2026.refreshThumbnail(_loc1_,var_108.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_173,var_108);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_173,!true ? getEventCtg(var_108.categoryId) : getRoomCtg(var_108.categoryId));
         refreshRoomDesc(var_173,var_108);
         refreshExtraCont();
         refreshInfo(var_173,"trading_allowed",var_108.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_195,Tabs.const_220,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
