package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_232);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.EXITROOM);
         var _loc2_:int = data == null && true ? 0 : int(data.settings.homeRoomId);
         ...
         else if(data != null && false && data.settings.homeRoomId > 0)
         {
            _loc1_.iconState = "homeroom";
         }
         else
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_157,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_176 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_129 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onNavigatorSettings(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:* = _navigator.data.settings == null;
         _navigator.data.settings = _loc2_;
         _navigator.mainViewCtrl.refresh();
         var _loc4_:int = -1;
         var _loc5_:int = -1;
         if(_loc3_)
