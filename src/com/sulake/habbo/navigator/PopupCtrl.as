package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_338 = new Timer(500,1);
         var_300 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1121 = param4;
         var_1814 = param2;
         _popupIndentLeft = param3;
         var_338.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_338)
         {
            var_338.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_338.reset();
            var_338 = null;
         }
         if(var_300)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_48 == null)
         {
            var_48 = IWindowContainer(_navigator.getXmlWindow(var_1121));
            var_48.visible = false;
            var_48.setParamFlag(HabboWindowParam.const_41,true);
         ...
         var_48.x = _loc2_.x + var_1814 + param1.width;
