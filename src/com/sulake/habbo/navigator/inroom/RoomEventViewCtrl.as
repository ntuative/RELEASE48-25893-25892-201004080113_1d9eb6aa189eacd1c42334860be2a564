package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_736:TextFieldManager;
      ...
      private var var_1334:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_736.getText();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1572 = IWindowContainer(find("event_type_disabled_cont"));
            var_2187 = ITextWindow(find("event_type_disabled_text"));
            var_1570 = ITextWindow(find("create_caption"));
            var_1571 = ITextWindow(find("edit_caption"));
            var_1336 = IButtonWindow(find("create_button"));
            var_1334 = IButtonWindow(find("edit_button"));
            var_2186 = IButtonWindow(find("cancel_button"));
            var_1335 = IButtonWindow(find("end_button"));
            var_907 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1336,onCreateButtonClick);
            Util.setProcDirectly(var_1334,onEditButtonClick);
            Util.setProcDirectly(var_1335,onEndButtonClick);
            Util.setProcDirectly(var_2186,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_736 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_906 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_908 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_736.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
