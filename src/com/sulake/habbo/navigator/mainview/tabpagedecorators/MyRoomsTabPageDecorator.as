package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_468:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_606;
         }
         if(param1 == 3)
         {
            return Tabs.const_599;
         }
         if(param1 == 4)
         {
            return Tabs.const_583;
         }
         return Tabs.const_232;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_468 == null ? 0 : int(var_468.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_255,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_468 == null)
         {
            var_468 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_468.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
