package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_96:IItemListWindow;
      
      private var var_769:TagListRenderer;
      
      protected var var_59:IItemListWindow;
      
      private var var_219:IBorderWindow;
      
      protected var _widget:InfostandWidget;
      
      private var var_106:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_769 = new TagListRenderer(param1,method_11);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_59 = _window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         var_59.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_.addEventListener(WindowEvent.const_45,onButtonResized);
         }
         if(var_219 != null)
         {
            var_96 = var_219.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_219.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_219.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_59.numListItems)
            {
               _loc13_ = var_59.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_219.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
               _loc10_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,showBadgeInfo);
               _loc10_.addEventListener(WindowMouseEvent.const_30,hideBadgeInfo);
            }
            _loc8_++;
         }
         _loc10_ = var_219.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_106.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_106.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_106.x = _loc5_.left - 0;
         var_106.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_96.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_96.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_96.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_96 == null || var_219 == null || var_59 == null)
         {
            return;
         }
         var_59.width = var_59.scrollableRegion.width;
         var_96.height = var_96.scrollableRegion.height;
         var_219.height = NaN;
         _window.width = Math.max(var_219.width,var_59.width);
      ...
      {
         var _loc2_:ITextWindow = var_96.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_96.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_96.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_96.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_769.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_96.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_96.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_96.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = var_59.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            var_59.arrangeListItems();
         }
      }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_59.getListItemByName(param1) as IRegionWindow;
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_106 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_106 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_59.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_836:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1013:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_106.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_106.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_106.x = _loc7_.left - 0;
         var_106.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_96.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_96.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_217:
               var_59.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_224:
               ...
               showButton("kick",(param1.amIOwner || param1.amIController || param1.amIAnyRoomController) && param1.method_3);
               showButton("ban",(param1.amIOwner || param1.amIAnyRoomController) && param1.method_3);
      ...
      {
         var _loc3_:IWindowContainer = var_96.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      private function method_11(param1:WindowMouseEvent) : void
      {
