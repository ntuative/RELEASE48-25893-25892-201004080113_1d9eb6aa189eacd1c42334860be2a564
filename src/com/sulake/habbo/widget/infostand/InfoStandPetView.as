package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1642:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1639:String = "level";
      
      private var var_96:IItemListWindow;
      
      private const const_1635:String = "energy";
      
      private var var_1171:Map;
      
      private const const_1637:String = "nutrition";
      
      private var var_59:IItemListWindow;
      
      private const const_1638:uint = 3355443;
      
      private var var_219:IBorderWindow;
      
      private const const_1640:int = 158;
      
      private const const_1636:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_269:PetCommandTool;
      
      private const const_1641:uint = 11184810;
      
      private const const_1643:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _loc4_ = 0;
         while(_loc4_ < var_59.numListItems)
         {
            _loc9_ = var_59.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc7_:* = [];
         var_59.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_96.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_96.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1171.getValue(var_699) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_96.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_96.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1639,param1.level,param1.levelMax);
         updateStateElement(const_1643,param1.experience,param1.experienceMax);
         updateStateElement(const_1635,param1.energy,param1.energyMax);
         updateStateElement(const_1637,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_699 = param1.id;
         var_1171.remove(param1.id);
         var_1171.add(param1.id,param1);
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_96.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = var_59.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_372,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1640,const_1636,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1641);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1638);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1642);
         return _loc5_;
      }
