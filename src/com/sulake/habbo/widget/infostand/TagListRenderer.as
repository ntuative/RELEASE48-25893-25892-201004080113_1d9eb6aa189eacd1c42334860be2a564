package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1177 != null && var_1177.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_109);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_826 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_826 += param1.height + const_1629;
            return fit(param1);
         }
         param1.offset(_offsetX,var_826);
         _offsetX += param1.width + const_1630;
         return true;
      }
