package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_495:int = 25;
      
      private static const const_1130:int = 6000;
      
      private static const const_1131:int = 9;
      
      private static const const_791:int = 4000;
      ...
      private static const const_497:int = (const_496 + const_348) * const_98 + const_98;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_240 = new Array();
         var_750 = new Point();
         var_157 = const_497 + const_279;
         super(param1,param2,param3);
         var_2227 = param5;
         var_37 = param1.createWindow("chat_container","",HabboWindowType.const_56,HabboWindowStyle.const_40,HabboWindowParam.const_39,new Rectangle(0,0,200,var_157 + RoomChatHistoryPulldown.const_72),null,0) as IWindowContainer;
         var_37.background = true;
         var_37.color = 33554431;
         var_37.tags.push("room_widget_chat");
         var_361 = param1.createWindow("chat_contentlist","",HabboWindowType.const_889,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,200,var_157),null,0) as IItemListWindow;
         var_37.addChild(var_361);
         var_136 = param1.createWindow("chat_active_content","",HabboWindowType.const_56,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,200,var_157),null,0) as IWindowContainer;
         var_361.addListItem(var_136);
         var_25 = new RoomChatHistoryViewer(this,param1,var_37,param2);
         var_2228 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_520,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         var_361.width = 0 - 0;
         var_361.height = var_157;
         var_136.width = 0 - 0;
         if(historyViewerActive())
         {
            var_136.height = getTotalContentHeight() + const_279;
         }
         else
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_966)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_64.length > const_1132 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_752 = getTimer() + const_791;
         }
         else
         {
            if(false && false)
            {
               var_617 = getItemSpacing(_itemList["-1"],var_64[0]);
            }
            else
            {
               var_617 = const_98;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_750.x) * var_924;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_792;
         var _loc6_:Number = 0 + const_792 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1350 && !historyViewerActive())
         {
            resetArea();
            var_1350 = false;
         }
      ...
      {
         return "chat_" + var_2227.toString() + "_item_" + (var_2229++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_520,onRoomViewUpdate);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1124 * const_1133;
            if(_loc2_ + var_751 > var_617)
            {
               _loc2_ = var_617 - var_751;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               var_924 = param1.scale / var_1589;
            }
         }
         if(param1.positionDelta != null)
         {
            var_750.x += param1.positionDelta.x / var_924;
            var_750.y += param1.positionDelta.y / var_924;
         }
         if(param1.rect != null)
         {
            if(var_25 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_2228)
         {
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_496 + const_348 + 2)
               {
                  _loc1_.aboveLevels = const_496 + const_348 + 2;
               }
               var_518 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_157 = param1 - 0;
         var_37.height = var_157 + RoomChatHistoryPulldown.const_72;
         if(var_25 != null)
         {
            var_25.containerResized(var_37.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_282,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_634,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_348 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1130)
               {
