package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1100:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_676,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_119,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_52,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_676,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_119,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_52,onDoorbellHandled);
      }
