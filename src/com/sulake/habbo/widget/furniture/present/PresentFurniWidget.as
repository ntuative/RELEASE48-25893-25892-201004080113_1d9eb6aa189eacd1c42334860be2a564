package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1031:Number = 100;
       
      
      private var var_226:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_77,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_453,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_420,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_442,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_363,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_77,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_453,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_420,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_442,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_363,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_60:
               hideInterface();
               var_226 = false;
               var_149 = param1.objectId;
               var_193 = param1.text;
               var_47 = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_420:
               if(!var_226)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_442:
               if(!var_226)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_363:
               if(!var_226)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_453:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_77:
               if(!var_226)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_617,var_149);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1030,const_1031,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_193 != null)
         {
            _loc4_.caption = var_193;
         }
