package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_97 && param1.type != WindowMouseEvent.const_478)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1402 * (var_949 - var_639)) + var_639;
      }
   }
}
