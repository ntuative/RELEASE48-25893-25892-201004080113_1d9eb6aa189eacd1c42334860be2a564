package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1279:XML;
      
      private var var_437:int;
      
      private var var_503:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2055:int;
      
      private var var_351:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1030,const_1031,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_503 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_351 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_503 != null)
         {
            var_503.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_351 != null)
         {
            var_351.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1054 = _loc2_.light;
         if(var_351 != null)
         {
            var_351.setValue(var_1054);
         }
         var_437 = colors.indexOf(_loc2_.color);
         if(var_503 != null)
         {
            var_503.setSelectedColorIndex(var_437);
         }
