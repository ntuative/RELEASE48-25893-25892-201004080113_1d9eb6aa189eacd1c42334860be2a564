package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1084:int = 30000;
      ...
      private var var_844:Timer = null;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_615,param1,param2,param3);
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            var_683 = var_683 - 1;
            _visualization.showFloodBlocking(var_683);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_623,onChatInputUpdate);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_939:
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_623,onChatInputUpdate);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_409 > const_1083)
         {
            if(_loc1_ < var_1215 + const_1085)
            {
               var_843 = true;
               var_683 = const_1084 / 1000;
               Logger.log("Enabling flood blocking");
               var_844 = new Timer(1000,var_683);
               var_844.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_844.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_844.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_683);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_539,_visualization.window);
         if(messageListener != null)
         {
