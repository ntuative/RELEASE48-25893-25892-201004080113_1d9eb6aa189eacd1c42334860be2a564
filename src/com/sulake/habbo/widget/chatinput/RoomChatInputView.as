package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1420:int = 5;
      
      private static const const_487:int = 16;
      
      private static const const_1074:int = 20;
      
      private static const const_340:int = 10;
      
      private static const const_1073:int = 40;
      ...
      private var var_428:Number = 600;
      ...
      private var var_677:Timer;
      
      private var var_835:Timer;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1018 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1893 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1891 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_677 = new Timer(1000,1);
         var_677.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_835 = new Timer(5000,1);
         var_835.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_56,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_45,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_143,onInputChanged);
         _window.addEventListener(WindowEvent.const_460,onWindowMoved);
         var_1196 = true;
         var_126 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1892 = _loc2_.width + const_487 + _loc6_.width + const_1074;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1073,_loc8_.width) + const_487);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1018 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_126 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_428);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_428);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_50,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_483);
