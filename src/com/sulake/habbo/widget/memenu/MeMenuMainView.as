package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function getClubAssetNameBase() : String
      {
         ...
         return "hc" + Math.min(5,Math.floor(0) + 1);
      }
      ...
      private function setElementImage(param1:String, param2:String, param3:Number = 1) : void
      {
         ...
         _loc4_.bitmap.copyPixels(_loc6_,_loc6_.rect,new Point(0,0));
         _loc4_.blend = param3;
      }
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_156[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_156[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_156)
         {
            _loc6_ = var_156[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        _widget.localizations.registerParameter("widget.memenu.hc.long","days",String(_widget.habboClubDays));
                        _widget.localizations.registerParameter("widget.memenu.hc.long","months",String(_widget.habboClubPeriods));
                        setElementText("hc_text",_widget.localizations.getKey("widget.memenu.hc.long"));
                     }
                     else
                     {
                        _widget.localizations.registerParameter("widget.memenu.hc","days",String(_widget.habboClubDays));
                        setElementText("hc_text",_widget.localizations.getKey("widget.memenu.hc"));
                     }
                     break;
                  case "news_icon":
                     if(true)
         ...
         while(_loc5_ < _window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_30,onMouseOverOrOut);
            _loc5_++;
         }
      ...
      {
         var_156 = new Dictionary();
         var_156["rooms_icon"] = ["gohome_white","gohome_color"];
         var_156["dance_icon"] = ["dance_white","dance_color"];
         var_156["clothes_icon"] = ["clothes_white","clothes_color"];
         var_156["effects_icon"] = ["effects_white","effects_color"];
         var_156["badges_icon"] = ["badges_white","badges_color"];
         var_156["wave_icon"] = ["wave_white","wave_color"];
         var_156["hc_icon"] = ["_white","_color"];
         var_156["settings_icon"] = ["settings_white","settings_color"];
         var_156["credits_icon"] = ["credits_white","credits_color"];
         var_156["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_896);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_913));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_991));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_318);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_835));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_577);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "true";
               if(false && _loc4_)
               {
