package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_162:IWidgetAvatarEffect;
      
      public function EffectView()
      {
         super();
         var_174 = new Timer(1000);
         var_174.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_781 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_162.duration);
               var_781.width = _loc2_ * var_428;
            }
            else
            {
               var_781.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               _window.addEventListener(WindowMouseEvent.const_30,onMouseEvent);
            }
            if(false)
            {
            ...
            var_782 = _window.findChildByName("effect_hilite");
            var_782.visible = false;
         }
         var_780 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_781 = _window.findChildByName("loader_bar");
         if(var_781 != null)
         {
            var_428 = var_781.width;
            var_174.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_162.icon);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_174.stop();
            var_174.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_174 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_780 != null)
         {
            var_780.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_780.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
