package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_705[var_1044] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_303)
         {
            ...
            var_303 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_303.center();
            var_303.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1044;
         if(var_1044 < var_705.length)
         {
            _loc1_ = var_705[var_1044] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_705.length);
                  _loc2_.text = _loc6_;
               }
