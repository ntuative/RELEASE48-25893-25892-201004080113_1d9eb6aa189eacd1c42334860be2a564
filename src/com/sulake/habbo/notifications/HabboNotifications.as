package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1090:String = "badges";
      
      private static const const_1093:String = "pet_inventory";
      
      private static const const_1089:String = "pixelbalance";
      
      private static const const_1092:String = "credits";
      
      private static const const_1094:String = "inventory";
      
      private static const const_1096:String = "friendlist";
      
      private static const const_1095:String = "selectfurni";
      
      private static const const_1091:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_574:ParkBusDialogManager;
      
      private var var_572:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_411:HabboNotificationViewManager;
      ...
      private var var_195:HabboAlertDialogManager;
      
      private var var_691:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_850);
         }
         var _loc6_:Map = var_850["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1202);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_691 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_195 == null)
         {
            return;
         }
         var_195.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_888)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1317);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_195.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_195.handleModMessage(_loc2_.message,_loc2_.url);
      }
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_81:
               ...
               else
               {
                  switch(_loc7_)
                  {
                     case FurniCategory.const_292:
                        _loc4_ = (var_10 as Component).assets.getAssetByName("icon_wallpaper_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
                        break;
                     case FurniCategory.const_296:
                        _loc4_ = (var_10 as Component).assets.getAssetByName("icon_landscape_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
                     ...
                     case FurniCategory.const_315:
                        _loc4_ = (var_10 as Component).assets.getAssetByName("icon_floor_png") as BitmapDataAsset;
                        if(_loc4_ != null)
                        {
                           _loc6_ = (_loc4_.content as BitmapData).clone();
                        }
               ...
               break;
            case CatalogPageMessageProductData.const_202:
               _loc4_ = (var_10 as Component).assets.getAssetByName("fx_icon_" + param2 + "_png") as BitmapDataAsset;
               if(_loc4_ != null)
               {
                  _loc6_ = (_loc4_.content as BitmapData).clone();
               }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1265);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_572)
         {
            var_572.release(new IIDHabboToolbar());
            var_572 = null;
         }
         if(_windowManager)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1090:
               if(var_10 != null)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_240);
               }
               break;
            case const_1091:
               break;
            ...
            case const_1093:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_145);
               }
               break;
            case const_1095:
               break;
      ...
      {
         if(param1 != null && this.var_411 != null)
         {
            var_411.replaceIcon(param1);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_573.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_878,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_178 || param2.type == WindowEvent.const_709)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_411.isSpaceAvailable() && false)
         {
            var_411.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_574 == null)
         {
            var_574 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_574 != null)
         {
            var_574.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1027.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_573.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_342);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc14_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc15_ = var_342.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_81)
               {
                  _loc15_ = var_342.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_342.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1346,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_573.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1027.push(_loc8_);
         return var_1027.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_225);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_195 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_572 = IHabboToolbar(param2);
         var_572.events.addEventListener(HabboToolbarEvent.const_82,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_195.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_342.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_886);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_886);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_195.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_292;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_296;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_82)
         {
            ...
            var_411 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_850["styles"],var_850["view"],var_572);
            ...
            registerUpdateReceiver(var_411,1);
            registerUpdateReceiver(this,2);
            var_342.events.addEventListener(BadgeImageReadyEvent.const_116,onBadgeImage);
            var_572.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
