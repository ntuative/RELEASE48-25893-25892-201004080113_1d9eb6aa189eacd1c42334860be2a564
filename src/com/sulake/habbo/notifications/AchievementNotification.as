package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1745 = param2;
         var_342 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_116,onBadgeImageReady);
         ...
         var_193 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2115 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_193);
      ...
      public function dispose() : void
      {
         if(var_342 != null)
         {
            var_342.events.removeEventListener(BadgeImageReadyEvent.const_116,onBadgeImageReady);
            var_342 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_727,var_2115);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_727,var_727));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_727,var_727));
         _localizations.registerParameter(param1,"level",var_1745.toString());
         _localizations.registerParameter(param1,"name",var_342.userName);
         _localizations.registerParameter(param1,"realname",var_342.realName);
      }
   }
}
