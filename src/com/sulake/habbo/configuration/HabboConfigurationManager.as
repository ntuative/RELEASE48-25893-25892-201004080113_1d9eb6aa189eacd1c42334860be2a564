package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1447:String = "%";
      ...
      {
         var _loc2_:String = var_988[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_1166 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_1166.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1448.indexOf(param1) < 0)
         {
            var_988[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_779 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_156));
         if(var_1791)
         {
      ...
      {
         var _loc4_:String = var_988[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1166);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1447);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1447,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function init() : void
      {
         ...
         if(!var_779)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_34,onInitConfiguration);
            _loc4_.addEventListener(AssetLoaderEvent.const_44,onConfigurationError);
         }
      }
