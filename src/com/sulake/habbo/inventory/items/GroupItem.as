package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1625:int = 13421772;
      ...
      protected var var_2276:BitmapData;
      
      protected var var_946:Boolean;
      
      protected var var_2270:Boolean;
      
      protected var var_1817:int;
      
      protected var _mainCategory:String;
      
      protected var var_449:int = 0;
      
      protected var var_1387:String;
      
      private const const_1624:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_371:BitmapData;
      
      private const const_1428:Number = 0.2;
      
      protected var var_1389:Boolean;
      
      private const const_1429:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_625)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_42)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1479));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1387);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1428;
               _loc1_.blend = const_1428;
            }
            else
            {
               _window.blend = const_1429;
               _loc1_.blend = const_1429;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1389 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2276;
               _loc5_.visible = true;
            }
            else
            {
