package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_24:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_10 = param1;
         var_24 = var_10.communication;
         var_24.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_24.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_24.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_24.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_24.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_24.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_24.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_24.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_24.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_24.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_24.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_24.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_24.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_24.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_24.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_24.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_24.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_24.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_24.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_24.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_24.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_24.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_24.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_24.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_24.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_24.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_24.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_24.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_24.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_24.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_24.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_24.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_24.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_24.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_24.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_24.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_24.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_24.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_10.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_73,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_10.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_10.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_10.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_569);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_10.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_165)
            {
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_43,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
         ...
         var _loc12_:TradingModel = var_10.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_10.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember);
            var_10.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         var _loc3_:MarketplaceModel = var_10.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_10.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_10.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_24.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_145);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_10.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_10.badgesModel;
      ...
      {
         var_10.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_325);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_73);
         ...
         if(_loc4_.getSelectedItemIndex(FurniModel.const_43) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_43,0);
         }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_10.sessionData;
         var _loc3_:IRoomSession = var_10.roomSession;
         if(_loc3_ == null)
         {
            return;
         }
         var_10.toggleInventorySubPage(InventorySubCategory.const_267);
         ...
         var _loc11_:TradingModel = var_10.tradingModel;
         if(_loc11_ != null)
         {
      ...
      {
         var _loc2_:PetsModel = var_10.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_10.setInventoryCategoryInit(InventoryCategory.const_240);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_415);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      {
         var_10.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
      ...
      private function onNotEnoughCredits(param1:NotEnoughBalanceMessageEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = var_10.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
