package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_772:IRoomSession;
      ...
      private const const_1620:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_17 != null)
         {
            var_17.events.removeEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_365,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_100:
               var_772 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_365:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_569));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_73));
      }
      ...
      {
         var_144.clubPeriods = param1;
         var_144.clubDays = param2;
         var_144.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_145));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1620);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_325));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_773.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_773.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_144.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_44.getValue(InventoryCategory.const_415) as MarketplaceModel;
      }
      ...
      {
         return var_144.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_144.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_240));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_365,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_415,_loc3_);
         ...
         var_44.add(InventoryCategory.const_73,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_342);
         var_44.add(InventoryCategory.const_240,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_44.add(InventoryCategory.const_569,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_342);
         var_44.add(InventoryCategory.const_325,_loc7_);
         ...
         var_44.add(InventoryCategory.const_145,_loc10_);
