package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1059:int = 100;
      
      public static const const_300:String = "pets";
      
      public static const const_43:String = "wall";
      
      public static const const_42:String = "floor";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_216,onObjectPlaced);
         var_470 = new Timer(const_1059,1);
         var_470.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
         ...
         _view.switchCategory(const_42);
      }
      
      public function get isTradingOpen() : Boolean
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_267;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc8_:int = 0;
         var _loc6_:Array = [const_42,const_43];
         var _loc7_:int = 0;
      ...
      {
         return var_47.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_388.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_388.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_625)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_216,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_470 != null)
            {
               var_470.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_470.stop();
               var_470 = null;
            }
            if(var_123 != null)
            {
               var_123.removeEventListener(TimerEvent.TIMER_COMPLETE,method_6);
               var_123.stop();
               var_123 = null;
            }
            if(var_667 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         {
            var_983 = param1.ref;
            if(!var_47.recyclerModel.running)
            {
               requestClose();
            }
            var_816 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_292)
         {
         ...
         else if(param3 == FurniCategory.const_315)
         {
         ...
         else if(param3 == FurniCategory.const_296)
         {
         ...
         if(var_667 == null)
         {
            var_667 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_667.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_47.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_42,const_43];
         var _loc6_:int = 0;
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_47.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_123 = new Timer(param1,1);
            var_123.addEventListener(TimerEvent.TIMER_COMPLETE,method_6);
            var_123.start();
         }
         else
         {
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_415);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_73 && false)
         {
            ...
            {
               case const_42:
                  var_47.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_43:
                  var_47.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_300:
                  var_47.toggleInventoryPage(InventoryCategory.const_145);
            }
         }
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = getCategoryContent(const_43);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = var_47.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc2_:TradingModel = var_47.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = var_47.recyclerModel;
         if(_loc3_ != null)
         {
         ...
         var _loc8_:Array = [const_42,const_43];
         var _loc9_:int = 0;
      ...
      {
         if(var_816 && param1.type == RoomEngineObjectEvent.const_216)
         {
            var_47.showView();
            var_816 = false;
         }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_42,const_43];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function removeFurni(param1:int) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         var _loc7_:Array = [const_42,const_43];
         var _loc8_:int = 0;
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_315 || _loc3_.category == FurniCategory.const_292 || _loc3_.category == FurniCategory.const_296)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_388.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_388 = new Map();
         var_388.add(const_42,new Array());
         var_388.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
