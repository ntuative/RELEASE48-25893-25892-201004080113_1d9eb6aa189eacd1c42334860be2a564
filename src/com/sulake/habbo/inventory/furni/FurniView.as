package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_697:MarketplaceModel;
      
      private var var_473:Map;
      
      private var var_474:String;
      
      private const const_1651:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_473 = new Map();
         var_473.add(FurniModel.const_42,new FurniGridView(_model,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         var_473.add(FurniModel.const_43,new FurniGridView(_model,FurniModel.const_43,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_55)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  switchCategory(FurniModel.const_43);
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_300);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_473.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_473.getValue(var_474);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_42,FurniModel.const_43];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = var_473.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_474);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_292)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_315)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_296)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_697 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_473.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
