package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         return var_456.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_50)
         {
            ...
            _model.toggleItemSelection(_category,var_456.getGridItemIndex(param1.window));
            var_333 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_30 && var_333 != null && var_333 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_97)
         {
            var_333 == null;
         }
         ...
         else if(param1.type == WindowMouseEvent.const_241)
         {
