package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_331:uint = 2;
      
      public static const const_412:uint = 4;
      ...
      public static const const_1229:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_507 = false;
         var_729 = false;
         var_45.updateItemList(var_728);
         var_45.updateItemList(var_1308);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_45.alertPopup(TradingView.const_982);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_728)
            {
               var_507 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_729 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_45.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_728)
            {
               var_45.alertPopup(TradingView.const_1005);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_31 + " NEW STATE: " + param1 + " OWN: " + var_507 + " OTHER: " + var_729);
         ...
         {
            case const_170:
               if(param1 == const_175 || param1 == const_230)
               {
                  var_31 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_45.setMinimized(param1 != InventoryCategory.const_73);
      ...
      public function close() : void
      {
         if(var_604)
         {
            if(var_31 != const_170 && var_31 != const_230)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_170;
            var_10.toggleInventorySubPage(InventorySubCategory.const_862);
            var_604 = false;
         }
         var_45.setMinimized(false);
      }
