package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_782:uint = 4284532064;
      
      private static const const_781:uint = 2577770;
      ...
      private var var_350:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_350 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_21.state)
                  {
                     case TradingModel.const_175:
                        if(var_21.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_901);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_933)
            {
            ...
            var_350.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_378);
            var_350.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_174)
            {
               var_174.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_174.stop();
               var_174 = null;
            }
            if(var_350 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1513 == null)
         {
            var_1513 = createMinimizedWindow();
         }
         if(!var_2052)
         {
            return var_61;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_174 == null)
         {
            var_174 = new Timer(1000,3);
            var_174.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_174.reset();
         var_174.repeatCount = 3;
         var_174.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_61)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_782) : uint(const_781);
            }
         ...
         if(var_61)
         {
            ...
            switch(var_21.state)
            {
               ...
               case TradingModel.const_259:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_412:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_230:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
