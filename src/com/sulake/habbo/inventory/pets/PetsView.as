package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_304:PetsGridItem;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_587.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_304 != null)
         {
            var_304.setSelected(false);
         }
         var_304 = param1;
         if(var_304 != null)
         {
            var_304.setSelected(true);
         }
         ...
         if(param1.type == WindowEvent.const_55)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  _model.switchCategory(FurniModel.const_43);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_304.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_587.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_587.getValue(param1.id) != null)
         {
            return;
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImage(_loc12_.figure,AvatarScaleType.const_51);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_38,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_38);
            _loc3_ = _loc12_.name;
