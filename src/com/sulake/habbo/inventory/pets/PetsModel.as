package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_145 && false)
         {
            var_47.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_47.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1371 && param1.type == RoomEngineObjectEvent.const_216)
         {
            var_47.showView();
            var_1371 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_47.roomSession.isRoomOwner)
         {
            var_1371 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_322,_loc3_.figure);
            var_47.closeView();
            return;
         }
         if(!var_47.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_1058.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
