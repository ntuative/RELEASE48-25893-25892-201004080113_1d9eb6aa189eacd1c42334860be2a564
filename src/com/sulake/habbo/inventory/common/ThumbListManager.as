package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_993:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_558 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_558.width;
         var_90 = var_558.height;
         var_992 = param5;
         var_823 = param6;
         var_221 = Math.floor(var_992 / _thumbWidth);
         var_18 = new BitmapData(var_992,var_823);
      }
      ...
      private function method_7(param1:Point) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc7_:int = 0;
         ...
         if(param1.y < var_471 - 1)
         {
            ...
            var_18.fillRect(new Rectangle(0,0 - var_90,var_18.width,var_90),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_18.width,0 - var_90);
               _loc2_ = new Rectangle(0,0,var_18.width,0 - var_90);
               _loc11_.copyPixels(var_18,_loc2_,new Point(0,0),null,null,true);
               var_18 = _loc11_;
               --var_471;
            }
         }
         if(var_18.height < var_823)
         {
            _loc12_ = new BitmapData(var_18.width,var_823);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_558.width,var_558.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_558.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_558,var_558.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_993 != null)
         {
            _loc1_ = var_993.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_471 = resolveRowCountFromList();
         if(var_471 == 0)
         {
            var_18 = new BitmapData(var_992,var_823);
            return;
         }
         var_18 = new BitmapData(Math.max(var_221 * _thumbWidth,var_992),Math.max(var_471 * var_90,var_823),true,16777215);
         var_18.fillRect(var_18.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_471)
         {
            _loc4_ = 0;
            while(_loc4_ < var_221)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_18.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_90),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_221 && var_18.height < _loc3_.y * var_90)
         {
            _loc2_ = new BitmapData(var_18.width,var_18.height + var_90);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_221 - 1),var_90);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_221 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_90),null,null,true);
         _loc4_ = new Rectangle(0,var_90,_thumbWidth * (var_221 - 1),0 - var_90);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,var_90),null,null,true);
         var_18 = _loc2_;
      }
