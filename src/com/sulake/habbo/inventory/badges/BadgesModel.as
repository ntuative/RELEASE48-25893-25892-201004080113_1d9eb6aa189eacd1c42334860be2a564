package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1621:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_342 = param6;
         var_342.events.addEventListener(BadgeImageReadyEvent.const_116,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_778.length)
         {
            if(var_778[_loc2_] == param1)
            {
               var_778.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_249[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_249.length)
               {
                  if((var_249[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_249[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function method_12(param1:int) : Badge
      {
      ...
      {
         if(param1 == InventoryCategory.const_240 && false)
         {
            var_47.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_342.getBadgeImage(param1);
            var_249.push(_loc8_);
            if(param2)
            {
