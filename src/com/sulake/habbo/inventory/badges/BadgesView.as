package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1080:IItemGridWindow;
      ...
      private var var_1079:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1079 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_1079.procedure = inactiveGridEventProc;
         var_1080 = _view.findChildByName("active_items") as IItemGridWindow;
         var_1080.procedure = activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1080.getGridItemIndex(param1.window);
      ...
      private function updateListViews() : void
      {
         ...
         var_1079.removeGridItems();
         var_1080.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_1079.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            var_1080.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1079.getGridItemIndex(param1.window);
            _loc4_ = _model.method_12(_loc3_);
            if(_loc4_ != null)
            {
               _model.setBadgeSelected(_loc4_.type);
            }
