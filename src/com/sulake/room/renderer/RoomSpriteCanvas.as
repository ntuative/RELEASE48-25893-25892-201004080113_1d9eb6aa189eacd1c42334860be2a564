package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_751:int = 50;
      ...
      private var var_217:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1703:Number = -10000000;
      
      private var var_1702:Number = -10000000;
      
      private var var_2340:int = 0;
      
      private var var_462:RoomObjectCache;
      
      private var var_657:int;
      
      private var var_252:Sprite;
      
      private var var_975:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_217 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_974 == 0)
         {
            checkMouseHits(var_976.x,var_976.y,MouseEvent.MOUSE_MOVE);
         }
         var_974 = 0;
         ++var_1423;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_252 != null)
         {
            var_252.graphics.clear();
         }
         else
         {
            var_252 = new Sprite();
            var_252.name = "mask";
            _master.addChild(var_252);
         }
         var_252.graphics.beginFill(0);
         var_252.graphics.drawRect(0,0,param1,param2);
         var_657 = param1;
         var_656 = param2;
         var_50.graphics.clear();
         var_50.graphics.beginFill(var_2340);
      ...
      {
         var _loc11_:Number = param1 - var_657 / 2;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_657 != var_1700 || var_656 != var_1699)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_386.sortOn("z",0 | 0);
         if(_loc6_ < var_386.length)
         {
            var_386.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_386[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_655.push(_loc12_ - _loc2_);
         if(var_655.length == const_751)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_751)
            {
               _loc13_ += var_655[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_460.length)
            {
               cleanSprite(var_460[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_460 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_294 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_294.length)
         {
            _loc2_ = var_294.getKey(_loc1_);
            _loc3_ = var_294.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_975 != null)
                  {
                     var_975.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1423,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_217.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_217.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_386.length)
         {
            return null;
         }
         return var_386[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_461.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_461.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1703 || param2 != var_1702)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_461.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_461.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_460.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_217.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_217.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_217.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_217.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_462.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_462.getObjectCache(param2);
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_657 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_656))
                  {
