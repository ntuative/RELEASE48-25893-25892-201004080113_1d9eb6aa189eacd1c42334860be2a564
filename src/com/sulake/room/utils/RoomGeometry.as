package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_565:Number = 64;
      
      public static const const_864:Number = 32;
      ...
      private var var_1473:Number = 1;
      
      private var var_74:int = 0;
      
      private var var_405:Map = null;
      
      private var var_1021:Vector3d;
      ...
      private var var_1475:Number = 1;
      
      private var var_2345:Number = 500;
      
      private var var_1474:Number = 1;
      
      private var var_84:Vector3d;
      
      private var var_85:Vector3d;
      
      private var var_2344:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_85 = new Vector3d();
         var_1021 = new Vector3d();
         var_1473 = 1;
         var_1474 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1475 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_223.assign(param1);
         if(var_223.x != _loc2_ || var_223.y != _loc3_ || var_223.z != _loc4_)
         {
            ++var_74;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            var_84.assign(_loc23_);
            _y.assign(_loc24_);
            var_85.assign(_loc25_);
         }
         else
         {
            var_84.assign(_loc18_);
            _y.assign(_loc19_);
      ...
      {
         if(var_407 != param1 * var_1475)
         {
            var_407 = param1 * var_1475;
            ++var_74;
         }
      }
      ...
      {
         if(var_406 != param1 * var_1473)
         {
            var_406 = param1 * var_1473;
            ++var_74;
         }
      }
      ...
      {
         if(var_408 != param1 * var_1474)
         {
            var_408 = param1 * var_1474;
            ++var_74;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_405 != null)
         {
            ...
            var_405.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_405.add(_loc3_,_loc4_);
            ++var_74;
         }
      }
      ...
      {
         return new Vector3d(var_223.x,var_223.y,var_223.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1021.assign(_loc22_);
         }
         else
         {
            var_1021.assign(_loc17_);
         }
         ++var_74;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_408;
         _loc2_.z *= var_407;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1021);
         if(_loc3_ < var_2344 || _loc3_ > var_2345)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_84);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_408;
            _loc2_.z *= var_407;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1021);
         }
      ...
      {
         return new Vector3d(0 * var_406,0 * var_408,0 * var_407);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_84);
      ...
      {
         return scale == const_565;
      }
      
      public function get scale() : Number
      {
         return var_197 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_405 != null)
         {
            ...
            return var_405.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_197;
         var _loc6_:Number = -param1.y / var_197;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_84,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_406,0 * var_408,0 * var_407);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_406,param2.y * var_408,param2.z * var_407);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_406,param3.y * var_408,param3.z * var_407);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_406,param4.y * var_408,param4.z * var_407);
