package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_255:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(var_178 != null)
         {
            while(false)
            {
               _loc1_ = var_178[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_178.length > param1)
         {
            _loc2_ = var_178["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < var_178.length)
         {
