package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_630:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_368 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_54 = var_368.clone();
            var_7 = var_368.clone();
         ...
         if(_loc13_)
         {
            var_435 = _loc13_.blend;
            var_536 = _loc13_.treshold;
            if(var_625 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_537 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_16)
            {
               var_14.invalidate(this,var_7,WindowRedrawFlag.const_70);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_139);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_336)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         var_625 = param1;
         var_537 = !!var_625 ? uint(var_537 | var_1382) : uint(var_537 & 16777215);
      ...
      {
         var_536 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2134 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_989:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_411:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_827:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_446:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_672:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_513:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_934:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_802:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_841:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_965:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_940:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_567:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_78 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_413,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_600,var_7);
            var_16.visible = var_336;
         }
         return var_16;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_860,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_934;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_435 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_816);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1071 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_288,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_536);
      }
      
      public function set color(param1:uint) : void
      {
         var_1382 = param1 & 4278190080;
         var_537 = !!var_625 ? uint(param1) : uint(param1 & 16777215);
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_70);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if(testParamFlag(WindowParam.const_294))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_208))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_261))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_208))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            ...
            {
               case WindowNotifyEvent.const_171:
                  var_14.invalidate(this,var_7.union(var_54),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_421,this,null));
                     if(testParamFlag(WindowParam.const_167,WindowParam.const_147))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_158,WindowParam.const_139))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_388))
                        {
                           var_8.width += 0 - 0;
                        }
                        ...
                        _param = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_252,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_411:
                  var_14.invalidate(this,var_7.union(var_54),WindowRedrawFlag.const_353);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_956,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_248,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_306:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_593,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_207,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_357:
                  var_14.invalidate(this,var_7,WindowRedrawFlag.const_905);
                  break;
               case WindowNotifyEvent.const_413:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_366:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_14.invalidate(this,var_7,WindowRedrawFlag.const_353);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_207:
                  ...
                  break;
               case WindowNotifyEvent.const_421:
                  var_8.getRegionProperties(null,var_309);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_288:
      ...
      {
         return var_630 != null ? var_630 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_834;
         update(this,_loc1_);
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_802,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,true);
         _loc1_.type = WindowNotifyEvent.const_796;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_536);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_567,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_849,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1071 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_379)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_384)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_989,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_646,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               var_54.x = var_7.x;
               var_54.y = var_7.y;
               var_54.width = var_7.width;
               var_54.height = var_7.height;
               var_7.x = param1;
               var_7.y = param2;
            }
            if(_loc6_)
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_411,this,null));
            }
            if(_loc6_)
            {
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_58,true);
         _loc1_.type = WindowNotifyEvent.const_1372;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_159 && var_536 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1547,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1547,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_14.invalidate(this,param1,WindowRedrawFlag.const_70);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1375,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_58,false);
         _loc1_.type = WindowNotifyEvent.const_1254;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_309 = var_8.rectangle.clone();
               var_54.x = var_7.x;
               var_54.y = var_7.y;
               var_54.width = var_7.width;
               var_54.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_380,this,var_8));
            }
            else
            {
               var_309.x = 0;
               ...
               var_309.width = 0;
               var_309.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_940,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_366,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,_param,var_14,var_7,null,var_630,properties,var_626.concat(),_id) as WindowController;
         _loc2_.var_536 = var_536;
         _loc2_.var_159 = var_159;
         _loc2_._debug = _debug;
         _loc2_.var_309 = var_309.clone();
         _loc2_.var_7 = var_7.clone();
         _loc2_.var_368 = var_368.clone();
         ...
         _loc2_.var_537 = var_537;
         _loc2_.var_1382 = var_1382;
         _loc2_.var_1105 = var_1105;
         _loc2_.var_336 = var_336;
         _loc2_.var_435 = var_435;
         _loc2_._param = _param;
         _loc2_.var_31 = var_31;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_322;
         _loc2_.background = var_625;
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_812,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_478;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_965;
         update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_832,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_882;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_31 == WindowState.const_389)
         {
            return true;
         }
         ...
         _loc1_.type = WindowNotifyEvent.const_827;
         update(this,_loc1_);
         dispose();
         return true;
      }
