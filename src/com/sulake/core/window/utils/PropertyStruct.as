package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_531:String = "Number";
      
      public static const const_61:String = "int";
      
      public static const STRING:String = "String";
      
      public static const const_662:String = "Point";
      
      public static const const_980:String = "Array";
      
      public static const const_867:String = "uint";
      
      public static const const_448:String = "hex";
      
      public static const const_842:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean)
      {
         ...
         _type = param3;
         var_1833 = param4;
         var_2300 = param3 == const_842 || param3 == const_980 || param3 == const_662 || param3 == const_659;
      }
      ...
      public function toXMLString() : String
      {
         ...
         switch(_type)
         {
            case const_842:
               ...
               _loc1_ = "<var key=\"" + var_560 + "\">\r<value>\r<" + _type + ">\r";
               _loc2_ = 0;
            ...
            case const_659:
               ...
               break;
            case const_448:
               _loc1_ = "<var key=\"" + var_560 + "\" value=\"" + "0x" + uint(var_164).toString(16) + "\" type=\"" + _type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + var_560 + "\" value=\"" + var_164 + "\" type=\"" + _type + "\" />";
         }
         return _loc1_;
      }
