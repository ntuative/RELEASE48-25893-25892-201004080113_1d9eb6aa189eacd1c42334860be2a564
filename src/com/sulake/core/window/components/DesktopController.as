package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      {
         var_630 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_950,var_7);
            GraphicContext(var_16).mouseEnabled = true;
            GraphicContext(var_16).doubleClickEnabled = true;
         }
         return var_16;
      }
