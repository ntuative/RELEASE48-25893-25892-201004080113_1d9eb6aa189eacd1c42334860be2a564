package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function ItemGridController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _horizontal = param2 != WindowType.const_392;
         var_532 = true;
         if(!_horizontal)
         {
      ...
      {
         var _loc2_:IItemListWindow = var_14.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_298,WindowStyle.const_333,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IItemListWindow;
      ...
      {
         var _loc2_:* = null;
         if(param1.type == WindowEvent.const_401)
         {
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            if(_loc6_)
            {
               ...
               {
                  if(_loc4_.rectangle.right + param1.width <= var_7.width)
                  {
                     return addColumnForItem(param1);
                  }
               }
