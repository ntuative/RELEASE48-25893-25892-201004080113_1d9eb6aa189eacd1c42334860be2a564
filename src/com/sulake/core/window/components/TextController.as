package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2337:Rectangle = new Rectangle();
       
      
      protected var var_207:Boolean;
      
      protected var var_66:TextMargins;
      
      protected var var_538:String = "none";
      
      protected var var_629:Number;
      
      protected var var_369:Number;
      ...
      {
         var_66 = new TextMargins(0,0,0,0,setTextMargins);
         var_207 = false;
         var_629 = 0;
         var_369 = 0;
         if(_field == null)
      ...
      {
         param1.var_66.dispose();
         param1.var_66 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_629 * maxScrollH,var_369 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_761)
         {
            context.removeLocalizationListener(var_322,this);
         }
         if(var_66 != null)
         {
            var_66.dispose();
      ...
      {
         var_629 = param1;
         _field.scrollH = var_629 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_322 = param1;
         if(var_322.charAt(0) == "$" && var_322.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_322.slice(2,var_322.indexOf("}")),this);
            var_761 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_207)
         {
            if(param2.type == WindowNotifyEvent.const_171)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_66.dispose();
            var_66 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_867,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_448,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_448,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_531,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_531,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_54,true));
         _loc1_.push(new PropertyStruct("margin_left",var_66.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_66.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_66.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_66.bottom,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("auto_size",var_538,PropertyStruct.STRING,var_538 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_531,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_629 = var_629;
         _loc1_.var_369 = var_369;
         _loc1_.var_66 = var_66.clone(_loc1_.setTextMargins);
         _loc1_.var_538 = var_538;
         _loc1_.var_761 = var_761;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_538 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_538 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_538 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_538 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
