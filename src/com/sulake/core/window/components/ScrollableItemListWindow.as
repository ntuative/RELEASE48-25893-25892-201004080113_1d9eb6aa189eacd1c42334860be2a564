package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_332:IScrollbarWindow;
      
      private var var_1410:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_332)
         {
            var_332 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_332)
            {
               var_332.addEventListener(WindowEvent.const_274,scrollBarEventProc);
               var_332.addEventListener(WindowEvent.const_227,scrollBarEventProc);
            }
         }
         return var_332;
      }
      ...
      override public function dispose() : void
      {
         if(var_332)
         {
            var_332.removeEventListener(WindowEvent.const_274,scrollBarEventProc);
            var_332.removeEventListener(WindowEvent.const_227,scrollBarEventProc);
            var_332 = null;
         }
         if(var_786)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_227)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_786)
         {
            var_786 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_786;
      }
