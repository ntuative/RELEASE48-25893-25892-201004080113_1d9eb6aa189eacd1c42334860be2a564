package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_761:String = "margin_top";
      
      private static const const_1058:String = "_HEADER";
      
      private static const const_763:String = "margin_right";
      
      private static const const_1055:String = "_SCALER";
      
      private static const const_1057:String = "_TITLE";
      
      private static const const_1056:String = "_CONTENT";
      
      private static const const_762:String = "margin_left";
      
      private static const const_760:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_66:IMargins;
      
      private var var_1375:Boolean = false;
      
      private var var_1164:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = var_66 != null;
         var _loc3_:Rectangle = content.rectangle;
         _loc1_.push(new PropertyStruct(const_762,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_761,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_763,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_66)
         {
            ...
            var_66 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_66;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_209);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_192);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_209,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_209,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_192,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_192,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1164 == null)
         {
            var_1164 = findChildByTag(const_1058) as IHeaderWindow;
            if(!var_1164)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1057) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1055) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1375 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1056) as IWindowContainer;
            if(!var_19)
            {
