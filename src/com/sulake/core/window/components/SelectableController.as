package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      public function get selector() : ISelectorWindow
      {
         ...
         if(var_8)
         {
            _loc1_ = var_8 as WindowController;
            while(_loc1_)
            {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_306)
         {
            if(var_8)
            {
               if(!(var_8 is ISelectorWindow))
               {
                  _loc3_ = var_8.parent as WindowController;
                  while(_loc3_)
                  {
                     if(_loc3_ is ISelectorWindow)
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_207,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_446,this,null);
         update(this,_loc1_);
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_672,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_513;
         update(this,_loc1_);
         return true;
      }
   }
