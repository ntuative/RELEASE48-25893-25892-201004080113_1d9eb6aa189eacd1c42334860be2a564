package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1109:String = "content";
      
      private static const const_1110:String = "selector";
       
      
      private var var_1283:Boolean = false;
      
      protected var var_945:ITabSelectorWindow;
      
      private var var_779:Boolean = false;
      
      protected var var_1604:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1604 == null)
         {
            var_1604 = findChildByTag(TabContextController.const_1109) as IWindowContainer;
         }
         return var_1604;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_945 == null)
         {
            var_945 = findChildByTag(TabContextController.const_1110) as ITabSelectorWindow;
            if(var_945 != null)
            {
               var_945.procedure = selectorEventProc;
            }
         }
         return var_945;
      }
      ...
      {
         return !!var_779 ? selector.iterator : null;
      }
