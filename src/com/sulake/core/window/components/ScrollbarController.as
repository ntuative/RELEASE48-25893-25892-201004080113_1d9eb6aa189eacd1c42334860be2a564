package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1046:String = "increment";
      
      private static const const_485:String = "slider_bar";
      
      private static const const_1045:String = "decrement";
      
      private static const const_752:String = "slider_track";
      ...
      protected var var_759:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_159 = false;
         var_20 = param12;
         _horizontal = param2 == WindowType.const_438;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_485:
               if(param2.type == WindowNotifyEvent.const_248)
               {
                  if(!var_552)
                  {
                     if(_horizontal)
      ...
      {
         return findChildByName(ScrollbarController.const_752) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_20 != null && true)
         {
            IWindow(var_20).removeEventListener(WindowEvent.const_45,onScrollableResized);
         }
         var_20 = param1;
         if(var_20 != null && true)
         {
            IWindow(var_20).addEventListener(WindowEvent.const_45,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_485) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_800 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_800 != null)
         {
            _loc1_ = findParentByName(var_800) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_800) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1046)
            {
               if(var_20)
               {
                  var_552 = true;
            ...
            else if(param2.name == ScrollbarController.const_1045)
            {
               if(var_20)
               {
                  var_552 = true;
            ...
            else if(param2.name == ScrollbarController.const_752)
            {
               _loc4_ = new Point();
               param2.getGlobalPosition(_loc4_);
               _loc4_.x = var_14.getDesktopWindow().mouseX - _loc4_.x;
               _loc4_.y = var_14.getDesktopWindow().mouseY - _loc4_.y;
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_485).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_941)
         {
