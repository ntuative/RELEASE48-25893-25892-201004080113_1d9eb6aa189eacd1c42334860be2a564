package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_337:String = "_DROPMENU_TITLETEXT";
       
      
      private var var_132:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_132 == null || false)
         {
            var_132 = context.create(name + "::submenu","",WindowType.const_480,var_78,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_132.setGlobalRectangle(_loc1_);
         }
         var_132.activate();
         return var_132;
      }
      ...
      {
         if(param1.type == WindowMouseEvent.const_97)
         {
            if(param2 is IDropMenuItemWindow)
            {
               if(param2.testStateFlag(WindowState.const_76))
               {
                  selection = getMenuItemIndex(param2 as IDropMenuItemWindow);
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_50)
         {
            if(param2 is IDropMenuItemWindow)
            {
               selection = getMenuItemIndex(param2 as IDropMenuItemWindow);
         ...
         else if(param1.type == WindowEvent.const_890)
         {
            if(param2 == var_132)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_463,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_304,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_504 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_504).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_599)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_505,getSubMenu(),subMenuEventProc);
                  var_599 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_446,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_504 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_312,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_132 != null)
            {
               _loc2_ = var_132.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      {
         return getChildByName(DropMenuController.const_337) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_599 = false;
            getTitleText().text = var_504 < var_505.length && var_504 > -1 ? "null" : caption;
         }
      }
   }
}
