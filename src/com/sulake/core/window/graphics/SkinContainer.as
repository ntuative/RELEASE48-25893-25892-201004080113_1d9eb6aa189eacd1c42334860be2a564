package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_373:Array;
      
      private static const const_779:uint = 8;
      ...
      private var var_702:Dictionary;
      
      private var var_1992:Dictionary;
      
      private var var_490:Dictionary;
      
      private var var_1253:Dictionary;
      
      private var var_701:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_702 = new Dictionary();
         var_701 = new Dictionary();
         var_1491 = new Dictionary();
         var_1992 = new Dictionary();
         TypeCodeTable.fillTables(var_1491,var_1992);
         var_1253 = new Dictionary();
         var_1991 = new Dictionary();
         StateCodeTable.fillTables(var_1253,var_1991);
         var_490 = new Dictionary();
         var_490["skin"] = BitmapSkinRenderer;
         var_490["bitmap"] = BitmapDataRenderer;
         var_490["fill"] = FillSkinRenderer;
         var_490["text"] = TextSkinRenderer;
         var_490["shape"] = ShapeSkinRenderer;
         var_490["unknown"] = SkinRenderer;
         var_490["com.sulake.habbo.widget.memenu"] = NullSkinRenderer;
         if(var_373 == null)
         {
            var_373 = new Array();
            var_373.push(WindowState.const_58);
            var_373.push(WindowState.const_66);
            var_373.push(WindowState.const_95);
            var_373.push(WindowState.WINDOW_STATE_SELECTED);
            var_373.push(WindowState.const_76);
            var_373.push(WindowState.const_71);
            var_373.push(WindowState.const_90);
            var_373.push(WindowState.const_87);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1491[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_701[param1];
      ...
      {
         var _loc3_:Array = var_702[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_702[param1] = new Array(SkinContainer.const_779);
         }
         var_702[param1][param2] = param3;
         if(true)
         {
            var_701[param1] = new Array(SkinContainer.const_779);
         }
         var_701[param1][param2] = param4;
      }
