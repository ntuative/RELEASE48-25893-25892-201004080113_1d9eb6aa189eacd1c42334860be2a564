package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_50:DisplayObjectContainer;
      ...
      private var var_295:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_554 = new Array();
         var_1435 = new Point();
         var_1434 = new Rectangle();
         var_296 = new Rectangle();
         var_295 = new Dictionary(true);
         var_641 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_295[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_554.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_296.x = _loc3_.dirty.x;
               var_296.y = _loc3_.dirty.y;
               var_296.width = _loc3_.dirty.width;
               var_296.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_296);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_525,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_295[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_295[param1];
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1435,var_1434))
            {
               if(param2.render(param1,var_1435,var_1434))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_641);
            var_295[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_525,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_70);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_296.x = param2.x - param1.x;
            var_296.y = param2.y - param1.y;
            var_296.width = param2.width;
            var_296.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  var_296.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_296,WindowRedrawFlag.const_244);
            if(var_554.indexOf(param1) == -1)
            {
               var_554.push(param1);
            }
         }
