package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_950:uint = 256;
      
      protected static var var_634:uint = 0;
      
      protected static var var_374:uint = 0;
      
      public static const const_885:uint = 2;
      
      public static const const_1549:uint = 128;
      
      public static const const_1461:uint = 64;
      
      public static const const_595:uint = 4;
      
      public static const const_1238:uint = 0;
      
      public static const const_1221:uint = 16;
      
      public static const const_600:uint = 1;
      
      public static const const_1234:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_631:Boolean;
      
      protected var var_1606:Boolean;
      
      protected var var_160:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_885:
               ...
               break;
            case GraphicContext.const_1234:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1221:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_595:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_950:
               break;
            case GraphicContext.const_1238:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_631)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_374 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_160 = new Sprite();
            var_160.name = this.name + " - Child Container";
            var_160.mouseEnabled = false;
            addChild(var_160);
         }
         return var_160;
      }
         ...
         if(var_631)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_374 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1606,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1606,16777215);
                  }
                  var_374 += bitmap.width * bitmap.height * 4;
               }
