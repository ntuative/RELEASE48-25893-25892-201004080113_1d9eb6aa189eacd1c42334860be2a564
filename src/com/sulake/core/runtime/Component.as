package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1608:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_900:uint = 4;
      ...
      protected var var_1104:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_936:String = "";
      
      protected var var_180:InterfaceStructList;
      
      protected var var_2266:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_391:uint = 0;
      
      protected var var_14:IContext = null;
      
      protected var var_2016:Boolean = false;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1104 = param2;
         var_180 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_180.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_936 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_936);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1104 & const_900)
         {
            if(_loc3_ == 0)
            {
               if(var_180.getTotalReferenceCount() == 0)
               {
                  var_14.detachComponent(this);
                  this.dispose();
               }
            }
         }
      ...
      {
         var_14.removeUpdateReceiver(param1);
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_180.getStructByIndex(_loc8_);
      ...
      {
         var_14.registerUpdateReceiver(param1,param2);
      }
      ...
      public function queueInterface(param1:IID, param2:Function = null) : IUnknown
      {
         ...
         if(_loc3_ == null)
         {
            return var_14.queueInterface(param1,param2);
         }
         if(_isDisposed)
         {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_391 + "]";
      }
   }
}
