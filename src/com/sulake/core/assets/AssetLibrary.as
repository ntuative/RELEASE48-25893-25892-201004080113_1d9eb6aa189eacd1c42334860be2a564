package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_859:String = "AssetLibraryReady";
      
      public static const const_1191:String = "AssetLibraryUnloaded";
      
      public static const const_464:String = "AssetLibraryLoaded";
      
      public static const const_1210:String = "AssetLibraryLoadError";
       
      
      private var var_452:XML;
      ...
      private var var_380:Dictionary;
      ...
      private var var_453:Boolean = true;
      
      private var var_330:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_547;
         var_379 = new Dictionary(false);
         var_380 = new Dictionary(false);
         var_649 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_379)
         {
            _loc4_ = AssetTypeDeclaration(var_379[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_380)
         {
            _loc2_ = var_380[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_380[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_649)
         {
            delete var_649[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
         ...
         var_291 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1191));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_452 = _loc2_.manifest.copy();
         var_330 = _loc2_.resource;
         if(var_453)
         {
            AssetLibrary.fetchLibraryContents(this,var_452,var_330);
         }
         var_291 = true;
         dispatchEvent(new Event(AssetLibrary.const_464));
         dispatchEvent(new Event(AssetLibrary.const_859));
         if(var_453)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_380[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_44,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_926,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_866,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1006,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_925,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_380[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_379.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_379[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_331.length ? getAssetByName(var_331[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1210));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_379)
         {
            _loc3_ = AssetTypeDeclaration(var_379[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_649[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_452.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_330[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_380[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_34:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_44,e.status);
                     break;
                  }
                  if(true)
                  {
                     ++var_184;
                     var_331.push(struct.assetName);
                  }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_331.splice(var_331.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_379[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_330 != null ? false : false;
      }
   }
}
