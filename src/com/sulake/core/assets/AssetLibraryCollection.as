package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_30:Array;
      
      protected var var_539:Array;
      
      private var var_634:uint = 0;
      
      protected var var_370:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_30 = new Array();
         var_539 = new Array();
         var_1110 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_370 = new AssetLibrary("lib-" + var_634++);
         var_30.push(var_370);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_370.createAsset(param1,param2);
      }
      ...
      private function getNumAssets() : uint
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ += IAssetLibrary(var_30[_loc3_]).numAssets;
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_370.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc4_ = var_30[_loc6_];
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_539.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
            (var_30.pop() as IAssetLibrary).dispose();
         }
      }
      ...
      {
         return var_370.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_370.loadAssetFromFile(param1,param2,param3);
      }
      ...
      public function getAssetByIndex(param1:uint) : IAsset
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc2_ += IAssetLibrary(var_30[_loc5_]).numAssets;
            if(_loc2_ <= param1)
            {
               return IAssetLibrary(var_30[_loc5_]).getAssetByIndex(param1 - _loc3_);
            }
            _loc3_ = uint(_loc2_);
            _loc5_++;
         }
      ...
      {
         return var_370.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_370.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_634++);
         var_539.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_539.length)
            {
               _loc3_ = var_539[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_539.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_370.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_370.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_370.loadFromArchive(param1,param2);
      }
      ...
      private function getAssetNameArray() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ = _loc1_.concat(IAssetLibrary(var_30[_loc3_]).nameArray);
            _loc3_++;
         }
         return _loc1_;
      }
