package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1134:int = 10000;
      ...
      private var var_745:IEncryption;
      
      private var var_744:int;
      
      private var var_359:ByteArray;
      ...
      private var var_360:IConnectionStateListener;
      
      private var var_612:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_298 = param2;
         var_359 = new ByteArray();
         var_918 = new MessageClassManager();
         var_77 = new Socket();
         var_358 = new Timer(const_1134,1);
         var_358.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_358.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_744));
      ...
      {
         var_358.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_744));
      ...
      private function onConnect(param1:Event) : void
      {
         var_358.stop();
         var_1345 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_744));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_612.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_360)
         {
            var_360.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_745 != null)
         {
            _loc3_ = var_745.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_360)
         {
            var_360.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_359.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_298.addConnectionMessageEvent(_id,param1);
      }
      ...
      {
         var_358.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_744));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_612.getMessages(var_359,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_360)
            {
               var_360.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_918.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_298.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_298.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_359,_loc2_);
            var_359 = _loc18_;
         }
      }
      ...
      {
         var_358.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_358.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_744));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_358.stop();
         var_1345 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_744));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_745 + "\n");
      }
   }
}
