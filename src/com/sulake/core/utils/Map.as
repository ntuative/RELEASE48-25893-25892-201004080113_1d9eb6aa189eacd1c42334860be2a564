package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_122[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_122)
         {
            delete var_122[_loc1_];
         }
         _length = 0;
         var_28 = [];
         var_220 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_122[param1] = param2;
         var _loc3_:int = var_220.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_28[_length] = param2;
            var_220[_length] = param1;
            ++_length;
         }
         else
         {
