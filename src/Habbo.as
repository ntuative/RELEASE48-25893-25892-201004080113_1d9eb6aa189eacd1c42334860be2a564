package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_20:String = "client.init.swf.loaded";
      
      public static const const_15:String = "client.init.volter.retry";
      
      public static const const_5:String = "barSprite";
      
      public static const const_9:String = "error_desc";
      ...
      public static const const_26:String = "client.init.core.init";
      
      public static const const_13:String = "client.init.swf.error";
      
      public static const const_21:int = 9;
      
      public static const const_16:String = "error_ctx";
      
      private static var _crashed:Boolean = false;
      
      public static const const_25:String = "client.init.core.fail";
      
      public static const const_18:String = "error_cat";
      ...
      public static const const_1:String = "habboLogo";
      
      private static const const_22:String = "HABBO_LOCAL_CONNECTION";
      
      public static const const_7:String = "client.init.start";
      
      public static const const_19:String = "debug";
      
      private static const const_6:Number = 0.29;
      
      public static const const_12:String = "avg_update";
      
      public static const const_10:String = "client.init.volter.loaded";
      
      private static const const_24:String = "testLocalConnection";
      
      public static const const_14:String = "error_data";
      
      public static const const_8:String = "flash_version";
      ...
      private var var_4:LocalConnection;
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc7_ = "";
            _loc6_[const_16] = _loc7_;
            _loc6_[const_8] = Capabilities.version;
            _loc6_[const_12] = 0;
            _loc6_[const_9] = param1;
            _loc6_[const_18] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_14] = String(param3.getStackTrace());
            }
            _loc6_[const_19] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private static function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc4_:Bitmap = param1.getChildByName(const_1) as Bitmap;
         if(_loc4_)
         {
            _loc4_.x = 117;
            _loc4_.y = 57;
         ...
         var _loc5_:Sprite = param1.getChildByName(LOADING_BAR) as Sprite;
         if(_loc5_)
         {
            _loc5_.x = 89;
            _loc5_.y = 149;
      ...
      private static function positionLoadingScreenTextField(param1:DisplayObjectContainer) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc3_ = param1.getChildByName(const_1) as Bitmap;
            if(_loc3_)
            {
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_21,error);
         }
      }
      ...
      public function createLoadingScreen() : DisplayObjectContainer
      {
         ...
         {
            _loc4_.text = stage.loaderInfo.parameters[const_3];
         }
         else
         {
            _loc4_.text = const_3;
      ...
      {
         var _loc7_:Sprite = param1.getChildByName(LOADING_BAR) as Sprite;
         var _loc8_:Sprite = _loc7_.getChildByName(const_5) as Sprite;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      public function disposeLoadingScreen(param1:DisplayObjectContainer) : void
      {
         ...
         _loc2_ = param1.getChildByName(LOADING_BAR);
         if(_loc2_)
         {
            param1.removeChild(_loc2_);
         }
